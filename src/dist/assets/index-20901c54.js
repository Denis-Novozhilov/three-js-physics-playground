...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ti,depthTest:!1,depthWrite:!1})}function Ac(){return new nr({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Qo(),fragmentShader:`
		...
		`,blending:Ti,depthTest:!1,depthWrite:!1})}function bc(){return new nr({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Qo(),fragmentShader:`
...
`)}function zg(s,t){const e={},n=s.getProgramParameter(t,s.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const r=s.getActiveAttrib(t,i),a=r.name;let o=1;r.type===s.FLOAT_MAT2&&(o=2),r.type===s.FLOAT_MAT3&&(o=3),r.type===s.FLOAT_MAT4&&(o=4),e[a]={type:r.type,location:s.getAttribLocation(t,a),locationSize:o}}return e}function es(s){return s!==""}function Fc(s,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Oc(s,t){return s.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const Vg=/^[ \t]*#include +<([\w\d./]+)>/gm;function bo(s){return s.replace(Vg,Hg)}const kg=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function Hg(s,t){let e=le[t];if(e===void 0){const n=kg.get(t);if(n!==void 0)e=le[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return bo(e)}const Gg=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Bc(s){return s.replace(Gg,Wg)}function Wg(s,t,e,n){let i="";for(let r=parseInt(t);r<parseInt(e);r++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function zc(s){let t="precision "+s.precision+` float;
precision `+s.precision+" int;";return s.precision==="highp"?t+=`
#define HIGH_PRECISION`:s.precision==="mediump"?t+=`
#define MEDIUM_PRECISION`:s.precision==="lowp"&&(t+=`
#define LOW_PRECISION`),t}function Xg(s){let t="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===vh?t="SHADOWMAP_TYPE_PCF":s.shadowMapType===gh?t="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===ri&&(t="SHADOWMAP_TYPE_VSM"),t}function qg(s){let t="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Fr:case Or:t="ENVMAP_TYPE_CUBE";break;case _a:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Yg(s){let t="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case Or:t="ENVMAP_MODE_REFRACTION";break}return t}function $g(s){let t="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case _h:t="ENVMAP_BLENDING_MULTIPLY";break;case Ld:t="ENVMAP_BLENDING_MIX";break;case Dd:t="ENVMAP_BLENDING_ADD";break}return t}function jg(s){const t=s.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function Kg(s,t,e,n){const i=s.getContext(),r=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=Xg(e),h=qg(e),c=Yg(e),u=$g(e),d=jg(e),f=e.isWebGL2?"":Og(e),v=Bg(r),g=i.createProgram();let m,p,_=e.glslVersion?"#version "+e.glslVersion+`
...
*/var Mn={autoSleep:120,force3D:"auto",nullTargetWarn:1,units:{lineHeight:""}},Vr={duration:.5,overwrite:!1,delay:0},nl,Qe,Ae,Pn=1e8,Ee=1/Pn,Ro=Math.PI*2,J_=Ro/4,Q_=0,Jh=Math.sqrt,t0=Math.cos,e0=Math.sin,qe=function(t){return typeof t=="string"},Le=function(t){return typeof t=="function"},hi=function(t){return typeof t=="number"},il=function(t){return typeof t>"u"},Zn=function(t){return typeof t=="object"},cn=function(t){return t!==!1},rl=function(){return typeof window<"u"},ta=function(t){return Le(t)||qe(t)},Qh=typeof ArrayBuffer=="function"&&ArrayBuffer.isView||function(){},tn=Array.isArray,Po=/(?:-?\.?\d|\.)+/gi,tu=/[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g,Rr=/[-+=.]*\d+[.e-]*\d*[a-z%]*/g,lo=/[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi,eu=/[+-]=-?[.\d]+/,nu=/[^,'"\[\]\s]+/gi,n0=/^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i,Ce,Hn,Lo,sl,Sn={},ua={},iu,ru=function(t){return(ua=ir(t,Sn))&&fn},al=function(t,e){return console.warn("Invalid property",t,"set to",e,"Missing plugin? gsap.registerPlugin()")},ms=function(t,e){return!e&&console.warn(t)},su=function(t,e){return t&&(Sn[t]=e)&&ua&&(ua[t]=e)||Sn},vs=function(){return 0},i0={suppressEvents:!0,isStart:!0,kill:!1},na={suppressEvents:!0,kill:!1},r0={suppressEvents:!0},ol={},Ci=[],Do={},au,xn={},co={},Jc=30,ia=[],ll="",cl=function(t){var e=t[0],n,i;if(Zn(e)||Le(e)||(t=[t]),!(n=(e._gsap||{}).harness)){for(i=ia.length;i--&&!ia[i].targetTest(e););n=ia[i]}for(i=t.length;i--;)t[i]&&(t[i]._gsap||(t[i]._gsap=new Pu(t[i],n)))||t.splice(i,1);return t},Ki=function(t){return t._gsap||cl(Ln(t))[0]._gsap},ou=function(t,e,n){return(n=t[e])&&Le(n)?t[e]():il(n)&&t.getAttribute&&t.getAttribute(e)||n},hn=function(t,e){return(t=t.split(",")).forEach(e)||t},Ne=function(t){return Math.round(t*1e5)/1e5||0},We=function(t){return Math.round(t*1e7)/1e7||0},Ir=function(t,e){var n=e.charAt(0),i=parseFloat(e.substr(2));return t=parseFloat(t),n==="+"?t+i:n==="-"?t-i:n==="*"?t*i:t/i},s0=function(t,e){for(var n=e.length,i=0;t.indexOf(e[i])<0&&++i<n;);return i<n},da=function(){var t=Ci.length,e=Ci.slice(0),n,i;for(Do={},Ci.length=0,n=0;n<t;n++)i=e[n],i&&i._lazy&&(i.render(i._lazy[0],i._lazy[1],!0)._lazy=0)},lu=function(t,e,n,i){Ci.length&&!Qe&&da(),t.render(e,n,i||Qe&&e<0&&(t._initted||t._startAt)),Ci.length&&!Qe&&da()},cu=function(t){var e=parseFloat(t);return(e||e===0)&&(t+"").match(nu).length<2?e:qe(t)?t.trim():t},hu=function(t){return t},In=function(t,e){for(var n in e)n in t||(t[n]=e[n]);return t},a0=function(t){return function(e,n){for(var i in n)i in e||i==="duration"&&t||i==="ease"||(e[i]=n[i])}},ir=function(t,e){for(var n in e)t[n]=e[n];return t},Qc=function s(t,e){for(var n in e)n!=="__proto__"&&n!=="constructor"&&n!=="prototype"&&(t[n]=Zn(e[n])?s(t[n]||(t[n]={}),e[n]):e[n]);return t},fa=function(t,e){var n={},i;for(i in t)i in e||(n[i]=t[i]);return n},os=function(t){var e=t.parent||Ce,n=t.keyframes?a0(tn(t.keyframes)):In;if(cn(t.inherit))for(;e;)n(t,e.vars.defaults),e=e.parent||e._dp;return t},o0=function(t,e){for(var n=t.length,i=n===e.length;i&&n--&&t[n]===e[n];);return n<0},uu=function(t,e,n,i,r){n===void 0&&(n="_first"),i===void 0&&(i="_last");var a=t[i],o;if(r)for(o=e[r];a&&a[r]>o;)a=a._prev;return a?(e._next=a._next,a._next=e):(e._next=t[n],t[n]=e),e._next?e._next._prev=e:t[i]=e,e._prev=a,e.parent=e._dp=t,e},wa=function(t,e,n,i){n===void 0&&(n="_first"),i===void 0&&(i="_last");var r=e._prev,a=e._next;r?r._next=a:t[n]===e&&(t[n]=a),a?a._prev=r:t[i]===e&&(t[i]=r),e._next=e._prev=e.parent=null},Li=function(t,e){t.parent&&(!e||t.parent.autoRemoveChildren)&&t.parent.remove&&t.parent.remove(t),t._act=0},Zi=function(t,e){if(t&&(!e||e._end>t._dur||e._start<0))for(var n=t;n;)n._dirty=1,n=n.parent;return t},l0=function(t){for(var e=t.parent;e&&e.parent;)e._dirty=1,e.totalDuration(),e=e.parent;return t},Io=function(t,e,n,i){return t._startAt&&(Qe?t._startAt.revert(na):t.vars.immediateRender&&!t.vars.autoRevert||t._startAt.render(e,!0,i))},c0=function s(t){return!t||t._ts&&s(t.parent)},th=function(t){return t._repeat?kr(t._tTime,t=t.duration()+t._rDelay)*t:0},kr=function(t,e){var n=Math.floor(t/=e);return t&&n===t?n-1:n},pa=function(t,e){return(t-e._start)*e._ts+(e._ts>=0?0:e._dirty?e.totalDuration():e._tDur)},Ta=function(t){return t._end=We(t._start+(t._tDur/Math.abs(t._ts||t._rts||Ee)||0))},Aa=function(t,e){var n=t._dp;return n&&n.smoothChildTiming&&t._ts&&(t._start=We(n._time-(t._ts>0?e/t._ts:((t._dirty?t.totalDuration():t._tDur)-e)/-t._ts)),Ta(t),n._dirty||Zi(n,t)),t},du=function(t,e){var n;if((e._time||!e._dur&&e._initted||e._start<t._time&&(e._dur||!e.add))&&(n=pa(t.rawTime(),e),(!e._dur||Ts(0,e.totalDuration(),n)-e._tTime>Ee)&&e.render(n,!0)),Zi(t,e)._dp&&t._initted&&t._time>=t._dur&&t._ts){if(t._dur<t.duration())for(n=t;n._dp;)n.rawTime()>=0&&n.totalTime(n._tTime),n=n._dp;t._zTime=-Ee}},Xn=function(t,e,n,i){return e.parent&&Li(e),e._start=We((hi(n)?n:n||t!==Ce?Tn(t,n,e):t._time)+e._delay),e._end=We(e._start+(e.totalDuration()/Math.abs(e.timeScale())||0)),uu(t,e,"_first","_last",t._sort?"_start":0),No(e)||(t._recent=e),i||du(t,e),t._ts<0&&Aa(t,t._tTime),t},fu=function(t,e){return(Sn.ScrollTrigger||al("scrollTrigger",e))&&Sn.ScrollTrigger.create(e,t)},pu=function(t,e,n,i,r){if(ul(t,e,r),!t._initted)return 1;if(!n&&t._pt&&!Qe&&(t._dur&&t.vars.lazy!==!1||!t._dur&&t.vars.lazy)&&au!==yn.frame)return Ci.push(t),t._lazy=[r,i],1},h0=function s(t){var e=t.parent;return e&&e._ts&&e._initted&&!e._lock&&(e.rawTime()<0||s(e))},No=function(t){var e=t.data;return e==="isFromStart"||e==="isStart"},u0=function(t,e,n,i){var r=t.ratio,a=e<0||!e&&(!t._start&&h0(t)&&!(!t._initted&&No(t))||(t._ts<0||t._dp._ts<0)&&!No(t))?0:1,o=t._rDelay,l=0,h,c,u;if(o&&t._repeat&&(l=Ts(0,t._tDur,e),c=kr(l,o),t._yoyo&&c&1&&(a=1-a),c!==kr(t._tTime,o)&&(r=1-a,t.vars.repeatRefresh&&t._initted&&t.invalidate())),a!==r||Qe||i||t._zTime===Ee||!e&&t._zTime){if(!t._initted&&pu(t,e,i,n,l))return;for(u=t._zTime,t._zTime=e||(n?Ee:0),n||(n=e&&!u),t.ratio=a,t._from&&(a=1-a),t._time=0,t._tTime=l,h=t._pt;h;)h.r(a,h.d),h=h._next;e<0&&Io(t,e,n,!0),t._onUpdate&&!n&&En(t,"onUpdate"),l&&t._repeat&&!n&&t.parent&&En(t,"onRepeat"),(e>=t._tDur||e<0)&&t.ratio===a&&(a&&Li(t,1),!n&&!Qe&&(En(t,a?"onComplete":"onReverseComplete",!0),t._prom&&t._prom()))}else t._zTime||(t._zTime=e)},d0=function(t,e,n){var i;if(n>e)for(i=t._first;i&&i._start<=n;){if(i.data==="isPause"&&i._start>e)return i;i=i._next}else for(i=t._last;i&&i._start>=n;){if(i.data==="isPause"&&i._start<e)return i;i=i._prev}},Hr=function(t,e,n,i){var r=t._repeat,a=We(e)||0,o=t._tTime/t._tDur;return o&&!i&&(t._time*=a/t._dur),t._dur=a,t._tDur=r?r<0?1e10:We(a*(r+1)+t._rDelay*r):a,o>0&&!i&&Aa(t,t._tTime=t._tDur*o),t.parent&&Ta(t),n||Zi(t.parent,t),t},eh=function(t){return t instanceof sn?Zi(t):Hr(t,t._dur)},f0={_start:0,endTime:vs,totalDuration:vs},Tn=function s(t,e,n){var i=t.labels,r=t._recent||f0,a=t.duration()>=Pn?r.endTime(!1):t._dur,o,l,h;return qe(e)&&(isNaN(e)||e in i)?(l=e.charAt(0),h=e.substr(-1)==="%",o=e.indexOf("="),l==="<"||l===">"?(o>=0&&(e=e.replace(/=/,"")),(l==="<"?r._start:r.endTime(r._repeat>=0))+(parseFloat(e.substr(1))||0)*(h?(o<0?r:n).totalDuration()/100:1)):o<0?(e in i||(i[e]=a),i[e]):(l=parseFloat(e.charAt(o-1)+e.substr(o+1)),h&&n&&(l=l/100*(tn(n)?n[0]:n).totalDuration()),o>1?s(t,e.substr(0,o-1),n)+l:a+l)):e==null?a:+e},ls=function(t,e,n){var i=hi(e[1]),r=(i?2:1)+(t<2?0:1),a=e[r],o,l;if(i&&(a.duration=e[1]),a.parent=n,t){for(o=a,l=n;l&&!("immediateRender"in o);)o=l.vars.defaults||{},l=cn(l.vars.inherit)&&l.parent;a.immediateRender=cn(o.immediateRender),t<2?a.runBackwards=1:a.startAt=e[r-1]}return new Oe(e[0],a,e[r+1])},Ni=function(t,e){return t||t===0?e(t):e},Ts=function(t,e,n){return n<t?t:n>e?e:n},Ze=function(t,e){return!qe(t)||!(e=n0.exec(t))?"":e[1]},p0=function(t,e,n){return Ni(n,function(i){return Ts(t,e,i)})},Uo=[].slice,mu=function(t,e){return t&&Zn(t)&&"length"in t&&(!e&&!t.length||t.length-1 in t&&Zn(t[0]))&&!t.nodeType&&t!==Hn},m0=function(t,e,n){return n===void 0&&(n=[]),t.forEach(function(i){var r;return qe(i)&&!e||mu(i,1)?(r=n).push.apply(r,Ln(i)):n.push(i)})||n},Ln=function(t,e,n){return Ae&&!e&&Ae.selector?Ae.selector(t):qe(t)&&!n&&(Lo||!Gr())?Uo.call((e||sl).querySelectorAll(t),0):tn(t)?m0(t,n):mu(t)?Uo.call(t,0):t?[t]:[]},Fo=function(t){return t=Ln(t)[0]||ms("Invalid scope")||{},function(e){var n=t.current||t.nativeElement||t;return Ln(e,n.querySelectorAll?n:n===t?ms("Invalid scope")||sl.createElement("div"):t)}},vu=function(t){return t.sort(function(){return .5-Math.random()})},gu=function(t){if(Le(t))return t;var e=Zn(t)?t:{each:t},n=Ji(e.ease),i=e.from||0,r=parseFloat(e.base)||0,a={},o=i>0&&i<1,l=isNaN(i)||o,h=e.axis,c=i,u=i;return qe(i)?c=u={center:.5,edges:.5,end:1}[i]||0:!o&&l&&(c=i[0],u=i[1]),function(d,f,v){var g=(v||e).length,m=a[g],p,_,x,y,E,A,b,R,M;if(!m){if(M=e.grid==="auto"?0:(e.grid||[1,Pn])[1],!M){for(b=-Pn;b<(b=v[M++].getBoundingClientRect().left)&&M<g;);M<g&&M--}for(m=a[g]=[],p=l?Math.min(M,g)*c-.5:i%M,_=M===Pn?0:l?g*u/M-.5:i/M|0,b=0,R=Pn,A=0;A<g;A++)x=A%M-p,y=_-(A/M|0),m[A]=E=h?Math.abs(h==="y"?y:x):Jh(x*x+y*y),E>b&&(b=E),E<R&&(R=E);i==="random"&&vu(m),m.max=b-R,m.min=R,m.v=g=(parseFloat(e.amount)||parseFloat(e.each)*(M>g?g-1:h?h==="y"?g/M:M:Math.max(M,g/M))||0)*(i==="edges"?-1:1),m.b=g<0?r-g:r,m.u=Ze(e.amount||e.each)||0,n=n&&g<0?bu(n):n}return g=(m[d]-m.min)/m.max||0,We(m.b+(n?n(g):g)*m.v)+m.u}},Oo=function(t){var e=Math.pow(10,((t+"").split(".")[1]||"").length);return function(n){var i=We(Math.round(parseFloat(n)/t)*t*e);return(i-i%1)/e+(hi(n)?0:Ze(n))}},_u=function(t,e){var n=tn(t),i,r;return!n&&Zn(t)&&(i=n=t.radius||Pn,t.values?(t=Ln(t.values),(r=!hi(t[0]))&&(i*=i)):t=Oo(t.increment)),Ni(e,n?Le(t)?function(a){return r=t(a),Math.abs(r-a)<=i?r:a}:function(a){for(var o=parseFloat(r?a.x:a),l=parseFloat(r?a.y:0),h=Pn,c=0,u=t.length,d,f;u--;)r?(d=t[u].x-o,f=t[u].y-l,d=d*d+f*f):d=Math.abs(t[u]-o),d<h&&(h=d,c=u);return c=!i||h<=i?t[c]:a,r||c===a||hi(a)?c:c+Ze(a)}:Oo(t))},xu=function(t,e,n,i){return Ni(tn(t)?!e:n===!0?!!(n=0):!i,function(){return tn(t)?t[~~(Math.random()*t.length)]:(n=n||1e-5)&&(i=n<1?Math.pow(10,(n+"").length-2):1)&&Math.floor(Math.round((t-n/2+Math.random()*(e-t+n*.99))/n)*n*i)/i})},v0=function(){for(var t=arguments.length,e=new Array(t),n=0;n<t;n++)e[n]=arguments[n];return function(i){return e.reduce(function(r,a){return a(r)},i)}},g0=function(t,e){return function(n){return t(parseFloat(n))+(e||Ze(n))}},_0=function(t,e,n){return Eu(t,e,0,1,n)},yu=function(t,e,n){return Ni(n,function(i){return t[~~e(i)]})},x0=function s(t,e,n){var i=e-t;return tn(t)?yu(t,s(0,t.length),e):Ni(n,function(r){return(i+(r-t)%i)%i+t})},y0=function s(t,e,n){var i=e-t,r=i*2;return tn(t)?yu(t,s(0,t.length-1),e):Ni(n,function(a){return a=(r+(a-t)%r)%r||0,t+(a>i?r-a:a)})},gs=function(t){for(var e=0,n="",i,r,a,o;~(i=t.indexOf("random(",e));)a=t.indexOf(")",i),o=t.charAt(i+7)==="[",r=t.substr(i+7,a-i-7).match(o?nu:Po),n+=t.substr(e,i-e)+xu(o?r:+r[0],o?0:+r[1],+r[2]||1e-5),e=a+1;return n+t.substr(e,t.length-e)},Eu=function(t,e,n,i,r){var a=e-t,o=i-n;return Ni(r,function(l){return n+((l-t)/a*o||0)})},E0=function s(t,e,n,i){var r=isNaN(t+e)?0:function(f){return(1-f)*t+f*e};if(!r){var a=qe(t),o={},l,h,c,u,d;if(n===!0&&(i=1)&&(n=null),a)t={p:t},e={p:e};else if(tn(t)&&!tn(e)){for(c=[],u=t.length,d=u-2,h=1;h<u;h++)c.push(s(t[h-1],t[h]));u--,r=function(v){v*=u;var g=Math.min(d,~~v);return c[g](v-g)},n=e}else i||(t=ir(tn(t)?[]:{},t));if(!c){for(l in e)hl.call(o,t,l,"get",e[l]);r=function(v){return pl(v,o)||(a?t.p:t)}}}return Ni(n,r)},nh=function(t,e,n){var i=t.labels,r=Pn,a,o,l;for(a in i)o=i[a]-e,o<0==!!n&&o&&r>(o=Math.abs(o))&&(l=a,r=o);return l},En=function(t,e,n){var i=t.vars,r=i[e],a=Ae,o=t._ctx,l,h,c;if(r)return l=i[e+"Params"],h=i.callbackScope||t,n&&Ci.length&&da(),o&&(Ae=o),c=l?r.apply(h,l):r.call(h),Ae=a,c},ns=function(t){return Li(t),t.scrollTrigger&&t.scrollTrigger.kill(!!Qe),t.progress()<1&&En(t,"onInterrupt"),t},Pr,Mu=[],Su=function(t){if(t)if(t=!t.name&&t.default||t,rl()||t.headless){var e=t.name,n=Le(t),i=e&&!n&&t.init?function(){this._props=[]}:t,r={init:vs,render:pl,add:hl,kill:O0,modifier:F0,rawVars:0},a={targetTest:0,get:0,getSetter:fl,aliases:{},register:0};if(Gr(),t!==i){if(xn[e])return;In(i,In(fa(t,r),a)),ir(i.prototype,ir(r,fa(t,a))),xn[i.prop=e]=i,t.targetTest&&(ia.push(i),ol[e]=1),e=(e==="css"?"CSS":e.charAt(0).toUpperCase()+e.substr(1))+"Plugin"}su(e,i),t.register&&t.register(fn,i,un)}else Mu.push(t)},ye=255,is={aqua:[0,ye,ye],lime:[0,ye,0],silver:[192,192,192],black:[0,0,0],maroon:[128,0,0],teal:[0,128,128],blue:[0,0,ye],navy:[0,0,128],white:[ye,ye,ye],olive:[128,128,0],yellow:[ye,ye,0],orange:[ye,165,0],gray:[128,128,128],purple:[128,0,128],green:[0,128,0],red:[ye,0,0],pink:[ye,192,203],cyan:[0,ye,ye],transparent:[ye,ye,ye,0]},ho=function(t,e,n){return t+=t<0?1:t>1?-1:0,(t*6<1?e+(n-e)*t*6:t<.5?n:t*3<2?e+(n-e)*(2/3-t)*6:e)*ye+.5|0},wu=function(t,e,n){var i=t?hi(t)?[t>>16,t>>8&ye,t&ye]:0:is.black,r,a,o,l,h,c,u,d,f,v;if(!i){if(t.substr(-1)===","&&(t=t.substr(0,t.length-1)),is[t])i=is[t];else if(t.charAt(0)==="#"){if(t.length<6&&(r=t.charAt(1),a=t.charAt(2),o=t.charAt(3),t="#"+r+r+a+a+o+o+(t.length===5?t.charAt(4)+t.charAt(4):"")),t.length===9)return i=parseInt(t.substr(1,6),16),[i>>16,i>>8&ye,i&ye,parseInt(t.substr(7),16)/255];t=parseInt(t.substr(1),16),i=[t>>16,t>>8&ye,t&ye]}else if(t.substr(0,3)==="hsl"){if(i=v=t.match(Po),!e)l=+i[0]%360/360,h=+i[1]/100,c=+i[2]/100,a=c<=.5?c*(h+1):c+h-c*h,r=c*2-a,i.length>3&&(i[3]*=1),i[0]=ho(l+1/3,r,a),i[1]=ho(l,r,a),i[2]=ho(l-1/3,r,a);else if(~t.indexOf("="))return i=t.match(tu),n&&i.length<4&&(i[3]=1),i}else i=t.match(Po)||is.transparent;i=i.map(Number)}return e&&!v&&(r=i[0]/ye,a=i[1]/ye,o=i[2]/ye,u=Math.max(r,a,o),d=Math.min(r,a,o),c=(u+d)/2,u===d?l=h=0:(f=u-d,h=c>.5?f/(2-u-d):f/(u+d),l=u===r?(a-o)/f+(a<o?6:0):u===a?(o-r)/f+2:(r-a)/f+4,l*=60),i[0]=~~(l+.5),i[1]=~~(h*100+.5),i[2]=~~(c*100+.5)),n&&i.length<4&&(i[3]=1),i},Tu=function(t){var e=[],n=[],i=-1;return t.split(Ri).forEach(function(r){var a=r.match(Rr)||[];e.push.apply(e,a),n.push(i+=a.length+1)}),e.c=n,e},ih=function(t,e,n){var i="",r=(t+i).match(Ri),a=e?"hsla(":"rgba(",o=0,l,h,c,u;if(!r)return t;if(r=r.map(function(d){return(d=wu(d,e,1))&&a+(e?d[0]+","+d[1]+"%,"+d[2]+"%,"+d[3]:d.join(","))+")"}),n&&(c=Tu(t),l=n.c,l.join(i)!==c.c.join(i)))for(h=t.replace(Ri,"1").split(Rr),u=h.length-1;o<u;o++)i+=h[o]+(~l.indexOf(o)?r.shift()||a+"0,0,0,0)":(c.length?c:r.length?r:n).shift());if(!h)for(h=t.split(Ri),u=h.length-1;o<u;o++)i+=h[o]+r[o];return i+h[u]},Ri=function(){var s="(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3,4}){1,2}\\b",t;for(t in is)s+="|"+t+"\\b";return new RegExp(s+")","gi")}(),M0=/hsl[a]?\(/,Au=function(t){var e=t.join(" "),n;if(Ri.lastIndex=0,Ri.test(e))return n=M0.test(e),t[1]=ih(t[1],n),t[0]=ih(t[0],n,Tu(t[1])),!0},_s,yn=function(){var s=Date.now,t=500,e=33,n=s(),i=n,r=1e3/240,a=r,o=[],l,h,c,u,d,f,v=function g(m){var p=s()-i,_=m===!0,x,y,E,A;if((p>t||p<0)&&(n+=p-e),i+=p,E=i-n,x=E-a,(x>0||_)&&(A=++u.frame,d=E-u.time*1e3,u.time=E=E/1e3,a+=x+(x>=r?4:r-x),y=1),_||(l=h(g)),y)for(f=0;f<o.length;f++)o[f](E,d,A,m)};return u={time:0,frame:0,tick:function(){v(!0)},deltaRatio:function(m){return d/(1e3/(m||60))},wake:function(){iu&&(!Lo&&rl()&&(Hn=Lo=window,sl=Hn.document||{},Sn.gsap=fn,(Hn.gsapVersions||(Hn.gsapVersions=[])).push(fn.version),ru(ua||Hn.GreenSockGlobals||!Hn.gsap&&Hn||{}),Mu.forEach(Su)),c=typeof requestAnimationFrame<"u"&&requestAnimationFrame,l&&u.sleep(),h=c||function(m){return setTimeout(m,a-u.time*1e3+1|0)},_s=1,v(2))},sleep:function(){(c?cancelAnimationFrame:clearTimeout)(l),_s=0,h=vs},lagSmoothing:function(m,p){t=m||1/0,e=Math.min(p||33,t)},fps:function(m){r=1e3/(m||240),a=u.time*1e3+r},add:function(m,p,_){var x=p?function(y,E,A,b){m(y,E,A,b),u.remove(x)}:m;return u.remove(m),o[_?"unshift":"push"](x),Gr(),x},remove:function(m,p){~(p=o.indexOf(m))&&o.splice(p,1)&&f>=p&&f--},_listeners:o},u}(),Gr=function(){return!_s&&yn.wake()},pe={},S0=/^[\d.\-M][\d.\-,\s]/,w0=/["']/g,T0=function(t){for(var e={},n=t.substr(1,t.length-3).split(":"),i=n[0],r=1,a=n.length,o,l,h;r<a;r++)l=n[r],o=r!==a-1?l.lastIndexOf(","):l.length,h=l.substr(0,o),e[i]=isNaN(h)?h.replace(w0,"").trim():+h,i=l.substr(o+1).trim();return e},A0=function(t){var e=t.indexOf("(")+1,n=t.indexOf(")"),i=t.indexOf("(",e);return t.substring(e,~i&&i<n?t.indexOf(")",n+1):n)},b0=function(t){var e=(t+"").split("("),n=pe[e[0]];return n&&e.length>1&&n.config?n.config.apply(null,~t.indexOf("{")?[T0(e[1])]:A0(t).split(",").map(cu)):pe._CE&&S0.test(t)?pe._CE("",t):n},bu=function(t){return function(e){return 1-t(1-e)}},Cu=function s(t,e){for(var n=t._first,i;n;)n instanceof sn?s(n,e):n.vars.yoyoEase&&(!n._yoyo||!n._repeat)&&n._yoyo!==e&&(n.timeline?s(n.timeline,e):(i=n._ease,n._ease=n._yEase,n._yEase=i,n._yoyo=e)),n=n._next},Ji=function(t,e){return t&&(Le(t)?t:pe[t]||b0(t))||e},or=function(t,e,n,i){n===void 0&&(n=function(l){return 1-e(1-l)}),i===void 0&&(i=function(l){return l<.5?e(l*2)/2:1-e((1-l)*2)/2});var r={easeIn:e,easeOut:n,easeInOut:i},a;return hn(t,function(o){pe[o]=Sn[o]=r,pe[a=o.toLowerCase()]=n;for(var l in r)pe[a+(l==="easeIn"?".in":l==="easeOut"?".out":".inOut")]=pe[o+"."+l]=r[l]}),r},Ru=function(t){return function(e){return e<.5?(1-t(1-e*2))/2:.5+t((e-.5)*2)/2}},uo=function s(t,e,n){var i=e>=1?e:1,r=(n||(t?.3:.45))/(e<1?e:1),a=r/Ro*(Math.asin(1/i)||0),o=function(c){return c===1?1:i*Math.pow(2,-10*c)*e0((c-a)*r)+1},l=t==="out"?o:t==="in"?function(h){return 1-o(1-h)}:Ru(o);return r=Ro/r,l.config=function(h,c){return s(t,h,c)},l},fo=function s(t,e){e===void 0&&(e=1.70158);var n=function(a){return a?--a*a*((e+1)*a+e)+1:0},i=t==="out"?n:t==="in"?function(r){return 1-n(1-r)}:Ru(n);return i.config=function(r){return s(t,r)},i};hn("Linear,Quad,Cubic,Quart,Quint,Strong",function(s,t){var e=t<5?t+1:t;or(s+",Power"+(e-1),t?function(n){return Math.pow(n,e)}:function(n){return n},function(n){return 1-Math.pow(1-n,e)},function(n){return n<.5?Math.pow(n*2,e)/2:1-Math.pow((1-n)*2,e)/2})});pe.Linear.easeNone=pe.none=pe.Linear.easeIn;or("Elastic",uo("in"),uo("out"),uo());(function(s,t){var e=1/t,n=2*e,i=2.5*e,r=function(o){return o<e?s*o*o:o<n?s*Math.pow(o-1.5/t,2)+.75:o<i?s*(o-=2.25/t)*o+.9375:s*Math.pow(o-2.625/t,2)+.984375};or("Bounce",function(a){return 1-r(1-a)},r)})(7.5625,2.75);or("Expo",function(s){return s?Math.pow(2,10*(s-1)):0});or("Circ",function(s){return-(Jh(1-s*s)-1)});or("Sine",function(s){return s===1?1:-t0(s*J_)+1});or("Back",fo("in"),fo("out"),fo());pe.SteppedEase=pe.steps=Sn.SteppedEase={config:function(t,e){t===void 0&&(t=1);var n=1/t,i=t+(e?0:1),r=e?1:0,a=1-Ee;return function(o){return((i*Ts(0,a,o)|0)+r)*n}}};Vr.ease=pe["quad.out"];hn("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt",function(s){return ll+=s+","+s+"Params,"});var Pu=function(t,e){this.id=Q_++,t._gsap=this,this.target=t,this.harness=e,this.get=e?e.get:ou,this.set=e?e.getSetter:fl},xs=function(){function s(e){this.vars=e,this._delay=+e.delay||0,(this._repeat=e.repeat===1/0?-2:e.repeat||0)&&(this._rDelay=e.repeatDelay||0,this._yoyo=!!e.yoyo||!!e.yoyoEase),this._ts=1,Hr(this,+e.duration,1,1),this.data=e.data,Ae&&(this._ctx=Ae,Ae.data.push(this)),_s||yn.wake()}var t=s.prototype;return t.delay=function(n){return n||n===0?(this.parent&&this.parent.smoothChildTiming&&this.startTime(this._start+n-this._delay),this._delay=n,this):this._delay},t.duration=function(n){return arguments.length?this.totalDuration(this._repeat>0?n+(n+this._rDelay)*this._repeat:n):this.totalDuration()&&this._dur},t.totalDuration=function(n){return arguments.length?(this._dirty=0,Hr(this,this._repeat<0?n:(n-this._repeat*this._rDelay)/(this._repeat+1))):this._tDur},t.totalTime=function(n,i){if(Gr(),!arguments.length)return this._tTime;var r=this._dp;if(r&&r.smoothChildTiming&&this._ts){for(Aa(this,n),!r._dp||r.parent||du(r,this);r&&r.parent;)r.parent._time!==r._start+(r._ts>=0?r._tTime/r._ts:(r.totalDuration()-r._tTime)/-r._ts)&&r.totalTime(r._tTime,!0),r=r.parent;!this.parent&&this._dp.autoRemoveChildren&&(this._ts>0&&n<this._tDur||this._ts<0&&n>0||!this._tDur&&!n)&&Xn(this._dp,this,this._start-this._delay)}return(this._tTime!==n||!this._dur&&!i||this._initted&&Math.abs(this._zTime)===Ee||!n&&!this._initted&&(this.add||this._ptLookup))&&(this._ts||(this._pTime=n),lu(this,n,i)),this},t.time=function(n,i){return arguments.length?this.totalTime(Math.min(this.totalDuration(),n+th(this))%(this._dur+this._rDelay)||(n?this._dur:0),i):this._time},t.totalProgress=function(n,i){return arguments.length?this.totalTime(this.totalDuration()*n,i):this.totalDuration()?Math.min(1,this._tTime/this._tDur):this.rawTime()>0?1:0},t.progress=function(n,i){return arguments.length?this.totalTime(this.duration()*(this._yoyo&&!(this.iteration()&1)?1-n:n)+th(this),i):this.duration()?Math.min(1,this._time/this._dur):this.rawTime()>0?1:0},t.iteration=function(n,i){var r=this.duration()+this._rDelay;return arguments.length?this.totalTime(this._time+(n-1)*r,i):this._repeat?kr(this._tTime,r)+1:1},t.timeScale=function(n,i){if(!arguments.length)return this._rts===-Ee?0:this._rts;if(this._rts===n)return this;var r=this.parent&&this._ts?pa(this.parent._time,this):this._tTime;return this._rts=+n||0,this._ts=this._ps||n===-Ee?0:this._rts,this.totalTime(Ts(-Math.abs(this._delay),this._tDur,r),i!==!1),Ta(this),l0(this)},t.paused=function(n){return arguments.length?(this._ps!==n&&(this._ps=n,n?(this._pTime=this._tTime||Math.max(-this._delay,this.rawTime()),this._ts=this._act=0):(Gr(),this._ts=this._rts,this.totalTime(this.parent&&!this.parent.smoothChildTiming?this.rawTime():this._tTime||this._pTime,this.progress()===1&&Math.abs(this._zTime)!==Ee&&(this._tTime-=Ee)))),this):this._ps},t.startTime=function(n){if(arguments.length){this._start=n;var i=this.parent||this._dp;return i&&(i._sort||!this.parent)&&Xn(i,this,n-this._delay),this}return this._start},t.endTime=function(n){return this._start+(cn(n)?this.totalDuration():this.duration())/Math.abs(this._ts||1)},t.rawTime=function(n){var i=this.parent||this._dp;return i?n&&(!this._ts||this._repeat&&this._time&&this.totalProgress()<1)?this._tTime%(this._dur+this._rDelay):this._ts?pa(i.rawTime(n),this):this._tTime:this._tTime},t.revert=function(n){n===void 0&&(n=r0);var i=Qe;return Qe=n,(this._initted||this._startAt)&&(this.timeline&&this.timeline.revert(n),this.totalTime(-.01,n.suppressEvents)),this.data!=="nested"&&n.kill!==!1&&this.kill(),Qe=i,this},t.globalTime=function(n){for(var i=this,r=arguments.length?n:i.rawTime();i;)r=i._start+r/(Math.abs(i._ts)||1),i=i._dp;return!this.parent&&this._sat?this._sat.globalTime(n):r},t.repeat=function(n){return arguments.length?(this._repeat=n===1/0?-2:n,eh(this)):this._repeat===-2?1/0:this._repeat},t.repeatDelay=function(n){if(arguments.length){var i=this._time;return this._rDelay=n,eh(this),i?this.time(i):this}return this._rDelay},t.yoyo=function(n){return arguments.length?(this._yoyo=n,this):this._yoyo},t.seek=function(n,i){return this.totalTime(Tn(this,n),cn(i))},t.restart=function(n,i){return this.play().totalTime(n?-this._delay:0,cn(i))},t.play=function(n,i){return n!=null&&this.seek(n,i),this.reversed(!1).paused(!1)},t.reverse=function(n,i){return n!=null&&this.seek(n||this.totalDuration(),i),this.reversed(!0).paused(!1)},t.pause=function(n,i){return n!=null&&this.seek(n,i),this.paused(!0)},t.resume=function(){return this.paused(!1)},t.reversed=function(n){return arguments.length?(!!n!==this.reversed()&&this.timeScale(-this._rts||(n?-Ee:0)),this):this._rts<0},t.invalidate=function(){return this._initted=this._act=0,this._zTime=-Ee,this},t.isActive=function(){var n=this.parent||this._dp,i=this._start,r;return!!(!n||this._ts&&this._initted&&n.isActive()&&(r=n.rawTime(!0))>=i&&r<this.endTime(!0)-Ee)},t.eventCallback=function(n,i,r){var a=this.vars;return arguments.length>1?(i?(a[n]=i,r&&(a[n+"Params"]=r),n==="onUpdate"&&(this._onUpdate=i)):delete a[n],this):a[n]},t.then=function(n){var i=this;return new Promise(function(r){var a=Le(n)?n:hu,o=function(){var h=i.then;i.then=null,Le(a)&&(a=a(i))&&(a.then||a===i)&&(i.then=h),r(a),i.then=h};i._initted&&i.totalProgress()===1&&i._ts>=0||!i._tTime&&i._ts<0?o():i._prom=o})},t.kill=function(){ns(this)},s}();In(xs.prototype,{_time:0,_start:0,_end:0,_tTime:0,_tDur:0,_dirty:0,_repeat:0,_yoyo:!1,parent:null,_initted:!1,_rDelay:0,_ts:1,_dp:0,ratio:0,_zTime:-Ee,_prom:0,_ps:!1,_rts:1});var sn=function(s){Zh(t,s);function t(n,i){var r;return n===void 0&&(n={}),r=s.call(this,n)||this,r.labels={},r.smoothChildTiming=!!n.smoothChildTiming,r.autoRemoveChildren=!!n.autoRemoveChildren,r._sort=cn(n.sortChildren),Ce&&Xn(n.parent||Ce,si(r),i),n.reversed&&r.reverse(),n.paused&&r.paused(!0),n.scrollTrigger&&fu(si(r),n.scrollTrigger),r}var e=t.prototype;return e.to=function(i,r,a){return ls(0,arguments,this),this},e.from=function(i,r,a){return ls(1,arguments,this),this},e.fromTo=function(i,r,a,o){return ls(2,arguments,this),this},e.set=function(i,r,a){return r.duration=0,r.parent=this,os(r).repeatDelay||(r.repeat=0),r.immediateRender=!!r.immediateRender,new Oe(i,r,Tn(this,a),1),this},e.call=function(i,r,a){return Xn(this,Oe.delayedCall(0,i,r),a)},e.staggerTo=function(i,r,a,o,l,h,c){return a.duration=r,a.stagger=a.stagger||o,a.onComplete=h,a.onCompleteParams=c,a.parent=this,new Oe(i,a,Tn(this,l)),this},e.staggerFrom=function(i,r,a,o,l,h,c){return a.runBackwards=1,os(a).immediateRender=cn(a.immediateRender),this.staggerTo(i,r,a,o,l,h,c)},e.staggerFromTo=function(i,r,a,o,l,h,c,u){return o.startAt=a,os(o).immediateRender=cn(o.immediateRender),this.staggerTo(i,r,o,l,h,c,u)},e.render=function(i,r,a){var o=this._time,l=this._dirty?this.totalDuration():this._tDur,h=this._dur,c=i<=0?0:We(i),u=this._zTime<0!=i<0&&(this._initted||!h),d,f,v,g,m,p,_,x,y,E,A,b;if(this!==Ce&&c>l&&i>=0&&(c=l),c!==this._tTime||a||u){if(o!==this._time&&h&&(c+=this._time-o,i+=this._time-o),d=c,y=this._start,x=this._ts,p=!x,u&&(h||(o=this._zTime),(i||!r)&&(this._zTime=i)),this._repeat){if(A=this._yoyo,m=h+this._rDelay,this._repeat<-1&&i<0)return this.totalTime(m*100+i,r,a);if(d=We(c%m),c===l?(g=this._repeat,d=h):(g=~~(c/m),g&&g===c/m&&(d=h,g--),d>h&&(d=h)),E=kr(this._tTime,m),!o&&this._tTime&&E!==g&&this._tTime-E*m-this._dur<=0&&(E=g),A&&g&1&&(d=h-d,b=1),g!==E&&!this._lock){var R=A&&E&1,M=R===(A&&g&1);if(g<E&&(R=!R),o=R?0:c%h?h:c,this._lock=1,this.render(o||(b?0:We(g*m)),r,!h)._lock=0,this._tTime=c,!r&&this.parent&&En(this,"onRepeat"),this.vars.repeatRefresh&&!b&&(this.invalidate()._lock=1),o&&o!==this._time||p!==!this._ts||this.vars.onRepeat&&!this.parent&&!this._act)return this;if(h=this._dur,l=this._tDur,M&&(this._lock=2,o=R?h:-1e-4,this.render(o,!0),this.vars.repeatRefresh&&!b&&this.invalidate()),this._lock=0,!this._ts&&!p)return this;Cu(this,b)}}if(this._hasPause&&!this._forcing&&this._lock<2&&(_=d0(this,We(o),We(d)),_&&(c-=d-(d=_._start))),this._tTime=c,this._time=d,this._act=!x,this._initted||(this._onUpdate=this.vars.onUpdate,this._initted=1,this._zTime=i,o=0),!o&&d&&!r&&!g&&(En(this,"onStart"),this._tTime!==c))return this;if(d>=o&&i>=0)for(f=this._first;f;){if(v=f._next,(f._act||d>=f._start)&&f._ts&&_!==f){if(f.parent!==this)return this.render(i,r,a);if(f.render(f._ts>0?(d-f._start)*f._ts:(f._dirty?f.totalDuration():f._tDur)+(d-f._start)*f._ts,r,a),d!==this._time||!this._ts&&!p){_=0,v&&(c+=this._zTime=-Ee);break}}f=v}else{f=this._last;for(var S=i<0?i:d;f;){if(v=f._prev,(f._act||S<=f._end)&&f._ts&&_!==f){if(f.parent!==this)return this.render(i,r,a);if(f.render(f._ts>0?(S-f._start)*f._ts:(f._dirty?f.totalDuration():f._tDur)+(S-f._start)*f._ts,r,a||Qe&&(f._initted||f._startAt)),d!==this._time||!this._ts&&!p){_=0,v&&(c+=this._zTime=S?-Ee:Ee);break}}f=v}}if(_&&!r&&(this.pause(),_.render(d>=o?0:-Ee)._zTime=d>=o?1:-1,this._ts))return this._start=y,Ta(this),this.render(i,r,a);this._onUpdate&&!r&&En(this,"onUpdate",!0),(c===l&&this._tTime>=this.totalDuration()||!c&&o)&&(y===this._start||Math.abs(x)!==Math.abs(this._ts))&&(this._lock||((i||!h)&&(c===l&&this._ts>0||!c&&this._ts<0)&&Li(this,1),!r&&!(i<0&&!o)&&(c||o||!l)&&(En(this,c===l&&i>=0?"onComplete":"onReverseComplete",!0),this._prom&&!(c<l&&this.timeScale()>0)&&this._prom())))}return this},e.add=function(i,r){var a=this;if(hi(r)||(r=Tn(this,r,i)),!(i instanceof xs)){if(tn(i))return i.forEach(function(o){return a.add(o,r)}),this;if(qe(i))return this.addLabel(i,r);if(Le(i))i=Oe.delayedCall(0,i);else return this}return this!==i?Xn(this,i,r):this},e.getChildren=function(i,r,a,o){i===void 0&&(i=!0),r===void 0&&(r=!0),a===void 0&&(a=!0),o===void 0&&(o=-Pn);for(var l=[],h=this._first;h;)h._start>=o&&(h instanceof Oe?r&&l.push(h):(a&&l.push(h),i&&l.push.apply(l,h.getChildren(!0,r,a)))),h=h._next;return l},e.getById=function(i){for(var r=this.getChildren(1,1,1),a=r.length;a--;)if(r[a].vars.id===i)return r[a]},e.remove=function(i){return qe(i)?this.removeLabel(i):Le(i)?this.killTweensOf(i):(wa(this,i),i===this._recent&&(this._recent=this._last),Zi(this))},e.totalTime=function(i,r){return arguments.length?(this._forcing=1,!this._dp&&this._ts&&(this._start=We(yn.time-(this._ts>0?i/this._ts:(this.totalDuration()-i)/-this._ts))),s.prototype.totalTime.call(this,i,r),this._forcing=0,this):this._tTime},e.addLabel=function(i,r){return this.labels[i]=Tn(this,r),this},e.removeLabel=function(i){return delete this.labels[i],this},e.addPause=function(i,r,a){var o=Oe.delayedCall(0,r||vs,a);return o.data="isPause",this._hasPause=1,Xn(this,o,Tn(this,i))},e.removePause=function(i){var r=this._first;for(i=Tn(this,i);r;)r._start===i&&r.data==="isPause"&&Li(r),r=r._next},e.killTweensOf=function(i,r,a){for(var o=this.getTweensOf(i,a),l=o.length;l--;)Mi!==o[l]&&o[l].kill(i,r);return this},e.getTweensOf=function(i,r){for(var a=[],o=Ln(i),l=this._first,h=hi(r),c;l;)l instanceof Oe?s0(l._targets,o)&&(h?(!Mi||l._initted&&l._ts)&&l.globalTime(0)<=r&&l.globalTime(l.totalDuration())>r:!r||l.isActive())&&a.push(l):(c=l.getTweensOf(o,r)).length&&a.push.apply(a,c),l=l._next;return a},e.tweenTo=function(i,r){r=r||{};var a=this,o=Tn(a,i),l=r,h=l.startAt,c=l.onStart,u=l.onStartParams,d=l.immediateRender,f,v=Oe.to(a,In({ease:r.ease||"none",lazy:!1,immediateRender:!1,time:o,overwrite:"auto",duration:r.duration||Math.abs((o-(h&&"time"in h?h.time:a._time))/a.timeScale())||Ee,onStart:function(){if(a.pause(),!f){var m=r.duration||Math.abs((o-(h&&"time"in h?h.time:a._time))/a.timeScale());v._dur!==m&&Hr(v,m,0,1).render(v._time,!0,!0),f=1}c&&c.apply(v,u||[])}},r));return d?v.render(0):v},e.tweenFromTo=function(i,r,a){return this.tweenTo(r,In({startAt:{time:Tn(this,i)}},a))},e.recent=function(){return this._recent},e.nextLabel=function(i){return i===void 0&&(i=this._time),nh(this,Tn(this,i))},e.previousLabel=function(i){return i===void 0&&(i=this._time),nh(this,Tn(this,i),1)},e.currentLabel=function(i){return arguments.length?this.seek(i,!0):this.previousLabel(this._time+Ee)},e.shiftChildren=function(i,r,a){a===void 0&&(a=0);for(var o=this._first,l=this.labels,h;o;)o._start>=a&&(o._start+=i,o._end+=i),o=o._next;if(r)for(h in l)l[h]>=a&&(l[h]+=i);return Zi(this)},e.invalidate=function(i){var r=this._first;for(this._lock=0;r;)r.invalidate(i),r=r._next;return s.prototype.invalidate.call(this,i)},e.clear=function(i){i===void 0&&(i=!0);for(var r=this._first,a;r;)a=r._next,this.remove(r),r=a;return this._dp&&(this._time=this._tTime=this._pTime=0),i&&(this.labels={}),Zi(this)},e.totalDuration=function(i){var r=0,a=this,o=a._last,l=Pn,h,c,u;if(arguments.length)return a.timeScale((a._repeat<0?a.duration():a.totalDuration())/(a.reversed()?-i:i));if(a._dirty){for(u=a.parent;o;)h=o._prev,o._dirty&&o.totalDuration(),c=o._start,c>l&&a._sort&&o._ts&&!a._lock?(a._lock=1,Xn(a,o,c-o._delay,1)._lock=0):l=c,c<0&&o._ts&&(r-=c,(!u&&!a._dp||u&&u.smoothChildTiming)&&(a._start+=c/a._ts,a._time-=c,a._tTime-=c),a.shiftChildren(-c,!1,-1/0),l=0),o._end>r&&o._ts&&(r=o._end),o=h;Hr(a,a===Ce&&a._time>r?a._time:r,1,1),a._dirty=0}return a._tDur},t.updateRoot=function(i){if(Ce._ts&&(lu(Ce,pa(i,Ce)),au=yn.frame),yn.frame>=Jc){Jc+=Mn.autoSleep||120;var r=Ce._first;if((!r||!r._ts)&&Mn.autoSleep&&yn._listeners.length<2){for(;r&&!r._ts;)r=r._next;r||yn.sleep()}}},t}(xs);In(sn.prototype,{_lock:0,_hasPause:0,_forcing:0});var C0=function(t,e,n,i,r,a,o){var l=new un(this._pt,t,e,0,1,Fu,null,r),h=0,c=0,u,d,f,v,g,m,p,_;for(l.b=n,l.e=i,n+="",i+="",(p=~i.indexOf("random("))&&(i=gs(i)),a&&(_=[n,i],a(_,t,e),n=_[0],i=_[1]),d=n.match(lo)||[];u=lo.exec(i);)v=u[0],g=i.substring(h,u.index),f?f=(f+1)%5:g.substr(-5)==="rgba("&&(f=1),v!==d[c++]&&(m=parseFloat(d[c-1])||0,l._pt={_next:l._pt,p:g||c===1?g:",",s:m,c:v.charAt(1)==="="?Ir(m,v)-m:parseFloat(v)-m,m:f&&f<4?Math.round:0},h=lo.lastIndex);return l.c=h<i.length?i.substring(h,i.length):"",l.fp=o,(eu.test(i)||p)&&(l.e=0),this._pt=l,l},hl=function(t,e,n,i,r,a,o,l,h,c){Le(i)&&(i=i(r||0,t,a));var u=t[e],d=n!=="get"?n:Le(u)?h?t[e.indexOf("set")||!Le(t["get"+e.substr(3)])?e:"get"+e.substr(3)](h):t[e]():u,f=Le(u)?h?I0:Nu:dl,v;if(qe(i)&&(~i.indexOf("random(")&&(i=gs(i)),i.charAt(1)==="="&&(v=Ir(d,i)+(Ze(d)||0),(v||v===0)&&(i=v))),!c||d!==i||Bo)return!isNaN(d*i)&&i!==""?(v=new un(this._pt,t,e,+d||0,i-(d||0),typeof u=="boolean"?U0:Uu,0,f),h&&(v.fp=h),o&&v.modifier(o,this,t),this._pt=v):(!u&&!(e in t)&&al(e,i),C0.call(this,t,e,d,i,f,l||Mn.stringFilter,h))},R0=function(t,e,n,i,r){if(Le(t)&&(t=cs(t,r,e,n,i)),!Zn(t)||t.style&&t.nodeType||tn(t)||Qh(t))return qe(t)?cs(t,r,e,n,i):t;var a={},o;for(o in t)a[o]=cs(t[o],r,e,n,i);return a},Lu=function(t,e,n,i,r,a){var o,l,h,c;if(xn[t]&&(o=new xn[t]).init(r,o.rawVars?e[t]:R0(e[t],i,r,a,n),n,i,a)!==!1&&(n._pt=l=new un(n._pt,r,t,0,1,o.render,o,0,o.priority),n!==Pr))for(h=n._ptLookup[n._targets.indexOf(r)],c=o._props.length;c--;)h[o._props[c]]=l;return o},Mi,Bo,ul=function s(t,e,n){var i=t.vars,r=i.ease,a=i.startAt,o=i.immediateRender,l=i.lazy,h=i.onUpdate,c=i.runBackwards,u=i.yoyoEase,d=i.keyframes,f=i.autoRevert,v=t._dur,g=t._startAt,m=t._targets,p=t.parent,_=p&&p.data==="nested"?p.vars.targets:m,x=t._overwrite==="auto"&&!nl,y=t.timeline,E,A,b,R,M,S,P,z,V,N,k,J,F;if(y&&(!d||!r)&&(r="none"),t._ease=Ji(r,Vr.ease),t._yEase=u?bu(Ji(u===!0?r:u,Vr.ease)):0,u&&t._yoyo&&!t._repeat&&(u=t._yEase,t._yEase=t._ease,t._ease=u),t._from=!y&&!!i.runBackwards,!y||d&&!i.stagger){if(z=m[0]?Ki(m[0]).harness:0,J=z&&i[z.prop],E=fa(i,ol),g&&(g._zTime<0&&g.progress(1),e<0&&c&&o&&!f?g.render(-1,!0):g.revert(c&&v?na:i0),g._lazy=0),a){if(Li(t._startAt=Oe.set(m,In({data:"isStart",overwrite:!1,parent:p,immediateRender:!0,lazy:!g&&cn(l),startAt:null,delay:0,onUpdate:h&&function(){return En(t,"onUpdate")},stagger:0},a))),t._startAt._dp=0,t._startAt._sat=t,e<0&&(Qe||!o&&!f)&&t._startAt.revert(na),o&&v&&e<=0&&n<=0){e&&(t._zTime=e);return}}else if(c&&v&&!g){if(e&&(o=!1),b=In({overwrite:!1,data:"isFromStart",lazy:o&&!g&&cn(l),immediateRender:o,stagger:0,parent:p},E),J&&(b[z.prop]=J),Li(t._startAt=Oe.set(m,b)),t._startAt._dp=0,t._startAt._sat=t,e<0&&(Qe?t._startAt.revert(na):t._startAt.render(-1,!0)),t._zTime=e,!o)s(t._startAt,Ee,Ee);else if(!e)return}for(t._pt=t._ptCache=0,l=v&&cn(l)||l&&!v,A=0;A<m.length;A++){if(M=m[A],P=M._gsap||cl(m)[A]._gsap,t._ptLookup[A]=N={},Do[P.id]&&Ci.length&&da(),k=_===m?A:_.indexOf(M),z&&(V=new z).init(M,J||E,t,k,_)!==!1&&(t._pt=R=new un(t._pt,M,V.name,0,1,V.render,V,0,V.priority),V._props.forEach(function(B){N[B]=R}),V.priority&&(S=1)),!z||J)for(b in E)xn[b]&&(V=Lu(b,E,t,k,M,_))?V.priority&&(S=1):N[b]=R=hl.call(t,M,b,"get",E[b],k,_,0,i.stringFilter);t._op&&t._op[A]&&t.kill(M,t._op[A]),x&&t._pt&&(Mi=t,Ce.killTweensOf(M,N,t.globalTime(e)),F=!t.parent,Mi=0),t._pt&&l&&(Do[P.id]=1)}S&&Ou(t),t._onInit&&t._onInit(t)}t._onUpdate=h,t._initted=(!t._op||t._pt)&&!F,d&&e<=0&&y.render(Pn,!0,!0)},P0=function(t,e,n,i,r,a,o,l){var h=(t._pt&&t._ptCache||(t._ptCache={}))[e],c,u,d,f;if(!h)for(h=t._ptCache[e]=[],d=t._ptLookup,f=t._targets.length;f--;){if(c=d[f][e],c&&c.d&&c.d._pt)for(c=c.d._pt;c&&c.p!==e&&c.fp!==e;)c=c._next;if(!c)return Bo=1,t.vars[e]="+=0",ul(t,o),Bo=0,l?ms(e+" not eligible for reset"):1;h.push(c)}for(f=h.length;f--;)u=h[f],c=u._pt||u,c.s=(i||i===0)&&!r?i:c.s+(i||0)+a*c.c,c.c=n-c.s,u.e&&(u.e=Ne(n)+Ze(u.e)),u.b&&(u.b=c.s+Ze(u.b))},L0=function(t,e){var n=t[0]?Ki(t[0]).harness:0,i=n&&n.aliases,r,a,o,l;if(!i)return e;r=ir({},e);for(a in i)if(a in r)for(l=i[a].split(","),o=l.length;o--;)r[l[o]]=r[a];return r},D0=function(t,e,n,i){var r=e.ease||i||"power1.inOut",a,o;if(tn(e))o=n[t]||(n[t]=[]),e.forEach(function(l,h){return o.push({t:h/(e.length-1)*100,v:l,e:r})});else for(a in e)o=n[a]||(n[a]=[]),a==="ease"||o.push({t:parseFloat(t),v:e[a],e:r})},cs=function(t,e,n,i,r){return Le(t)?t.call(e,n,i,r):qe(t)&&~t.indexOf("random(")?gs(t):t},Du=ll+"repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,autoRevert",Iu={};hn(Du+",id,stagger,delay,duration,paused,scrollTrigger",function(s){return Iu[s]=1});var Oe=function(s){Zh(t,s);function t(n,i,r,a){var o;typeof i=="number"&&(r.duration=i,i=r,r=null),o=s.call(this,a?i:os(i))||this;var l=o.vars,h=l.duration,c=l.delay,u=l.immediateRender,d=l.stagger,f=l.overwrite,v=l.keyframes,g=l.defaults,m=l.scrollTrigger,p=l.yoyoEase,_=i.parent||Ce,x=(tn(n)||Qh(n)?hi(n[0]):"length"in i)?[n]:Ln(n),y,E,A,b,R,M,S,P;if(o._targets=x.length?cl(x):ms("GSAP target "+n+" not found. https://gsap.com",!Mn.nullTargetWarn)||[],o._ptLookup=[],o._overwrite=f,v||d||ta(h)||ta(c)){if(i=o.vars,y=o.timeline=new sn({data:"nested",defaults:g||{},targets:_&&_.data==="nested"?_.vars.targets:x}),y.kill(),y.parent=y._dp=si(o),y._start=0,d||ta(h)||ta(c)){if(b=x.length,S=d&&gu(d),Zn(d))for(R in d)~Du.indexOf(R)&&(P||(P={}),P[R]=d[R]);for(E=0;E<b;E++)A=fa(i,Iu),A.stagger=0,p&&(A.yoyoEase=p),P&&ir(A,P),M=x[E],A.duration=+cs(h,si(o),E,M,x),A.delay=(+cs(c,si(o),E,M,x)||0)-o._delay,!d&&b===1&&A.delay&&(o._delay=c=A.delay,o._start+=c,A.delay=0),y.to(M,A,S?S(E,M,x):0),y._ease=pe.none;y.duration()?h=c=0:o.timeline=0}else if(v){os(In(y.vars.defaults,{ease:"none"})),y._ease=Ji(v.ease||i.ease||"none");var z=0,V,N,k;if(tn(v))v.forEach(function(J){return y.to(x,J,">")}),y.duration();else{A={};for(R in v)R==="ease"||R==="easeEach"||D0(R,v[R],A,v.easeEach);for(R in A)for(V=A[R].sort(function(J,F){return J.t-F.t}),z=0,E=0;E<V.length;E++)N=V[E],k={ease:N.e,duration:(N.t-(E?V[E-1].t:0))/100*h},k[R]=N.v,y.to(x,k,z),z+=k.duration;y.duration()<h&&y.to({},{duration:h-y.duration()})}}h||o.duration(h=y.duration())}else o.timeline=0;return f===!0&&!nl&&(Mi=si(o),Ce.killTweensOf(x),Mi=0),Xn(_,si(o),r),i.reversed&&o.reverse(),i.paused&&o.paused(!0),(u||!h&&!v&&o._start===We(_._time)&&cn(u)&&c0(si(o))&&_.data!=="nested")&&(o._tTime=-Ee,o.render(Math.max(0,-c)||0)),m&&fu(si(o),m),o}var e=t.prototype;return e.render=function(i,r,a){var o=this._time,l=this._tDur,h=this._dur,c=i<0,u=i>l-Ee&&!c?l:i<Ee?0:i,d,f,v,g,m,p,_,x,y;if(!h)u0(this,i,r,a);else if(u!==this._tTime||!i||a||!this._initted&&this._tTime||this._startAt&&this._zTime<0!==c){if(d=u,x=this.timeline,this._repeat){if(g=h+this._rDelay,this._repeat<-1&&c)return this.totalTime(g*100+i,r,a);if(d=We(u%g),u===l?(v=this._repeat,d=h):(v=~~(u/g),v&&v===We(u/g)&&(d=h,v--),d>h&&(d=h)),p=this._yoyo&&v&1,p&&(y=this._yEase,d=h-d),m=kr(this._tTime,g),d===o&&!a&&this._initted&&v===m)return this._tTime=u,this;v!==m&&(x&&this._yEase&&Cu(x,p),this.vars.repeatRefresh&&!p&&!this._lock&&this._time!==g&&this._initted&&(this._lock=a=1,this.render(We(g*v),!0).invalidate()._lock=0))}if(!this._initted){if(pu(this,c?i:d,a,r,u))return this._tTime=0,this;if(o!==this._time&&!(a&&this.vars.repeatRefresh&&v!==m))return this;if(h!==this._dur)return this.render(i,r,a)}if(this._tTime=u,this._time=d,!this._act&&this._ts&&(this._act=1,this._lazy=0),this.ratio=_=(y||this._ease)(d/h),this._from&&(this.ratio=_=1-_),d&&!o&&!r&&!v&&(En(this,"onStart"),this._tTime!==u))return this;for(f=this._pt;f;)f.r(_,f.d),f=f._next;x&&x.render(i<0?i:x._dur*x._ease(d/this._dur),r,a)||this._startAt&&(this._zTime=i),this._onUpdate&&!r&&(c&&Io(this,i,r,a),En(this,"onUpdate")),this._repeat&&v!==m&&this.vars.onRepeat&&!r&&this.parent&&En(this,"onRepeat"),(u===this._tDur||!u)&&this._tTime===u&&(c&&!this._onUpdate&&Io(this,i,!0,!0),(i||!h)&&(u===this._tDur&&this._ts>0||!u&&this._ts<0)&&Li(this,1),!r&&!(c&&!o)&&(u||o||p)&&(En(this,u===l?"onComplete":"onReverseComplete",!0),this._prom&&!(u<l&&this.timeScale()>0)&&this._prom()))}return this},e.targets=function(){return this._targets},e.invalidate=function(i){return(!i||!this.vars.runBackwards)&&(this._startAt=0),this._pt=this._op=this._onUpdate=this._lazy=this.ratio=0,this._ptLookup=[],this.timeline&&this.timeline.invalidate(i),s.prototype.invalidate.call(this,i)},e.resetTo=function(i,r,a,o,l){_s||yn.wake(),this._ts||this.play();var h=Math.min(this._dur,(this._dp._time-this._start)*this._ts),c;return this._initted||ul(this,h),c=this._ease(h/this._dur),P0(this,i,r,a,o,c,h,l)?this.resetTo(i,r,a,o,1):(Aa(this,0),this.parent||uu(this._dp,this,"_first","_last",this._dp._sort?"_start":0),this.render(0))},e.kill=function(i,r){if(r===void 0&&(r="all"),!i&&(!r||r==="all"))return this._lazy=this._pt=0,this.parent?ns(this):this;if(this.timeline){var a=this.timeline.totalDuration();return this.timeline.killTweensOf(i,r,Mi&&Mi.vars.overwrite!==!0)._first||ns(this),this.parent&&a!==this.timeline.totalDuration()&&Hr(this,this._dur*this.timeline._tDur/a,0,1),this}var o=this._targets,l=i?Ln(i):o,h=this._ptLookup,c=this._pt,u,d,f,v,g,m,p;if((!r||r==="all")&&o0(o,l))return r==="all"&&(this._pt=0),ns(this);for(u=this._op=this._op||[],r!=="all"&&(qe(r)&&(g={},hn(r,function(_){return g[_]=1}),r=g),r=L0(o,r)),p=o.length;p--;)if(~l.indexOf(o[p])){d=h[p],r==="all"?(u[p]=r,v=d,f={}):(f=u[p]=u[p]||{},v=r);for(g in v)m=d&&d[g],m&&((!("kill"in m.d)||m.d.kill(g)===!0)&&wa(this,m,"_pt"),delete d[g]),f!=="all"&&(f[g]=1)}return this._initted&&!this._pt&&c&&ns(this),this},t.to=function(i,r){return new t(i,r,arguments[2])},t.from=function(i,r){return ls(1,arguments)},t.delayedCall=function(i,r,a,o){return new t(r,0,{immediateRender:!1,lazy:!1,overwrite:!1,delay:i,onComplete:r,onReverseComplete:r,onCompleteParams:a,onReverseCompleteParams:a,callbackScope:o})},t.fromTo=function(i,r,a){return ls(2,arguments)},t.set=function(i,r){return r.duration=0,r.repeatDelay||(r.repeat=0),new t(i,r)},t.killTweensOf=function(i,r,a){return Ce.killTweensOf(i,r,a)},t}(xs);In(Oe.prototype,{_targets:[],_lazy:0,_startAt:0,_op:0,_onInit:0});hn("staggerTo,staggerFrom,staggerFromTo",function(s){Oe[s]=function(){var t=new sn,e=Uo.call(arguments,0);return e.splice(s==="staggerFromTo"?5:4,0,0),t[s].apply(t,e)}});var dl=function(t,e,n){return t[e]=n},Nu=function(t,e,n){return t[e](n)},I0=function(t,e,n,i){return t[e](i.fp,n)},N0=function(t,e,n){return t.setAttribute(e,n)},fl=function(t,e){return Le(t[e])?Nu:il(t[e])&&t.setAttribute?N0:dl},Uu=function(t,e){return e.set(e.t,e.p,Math.round((e.s+e.c*t)*1e6)/1e6,e)},U0=function(t,e){return e.set(e.t,e.p,!!(e.s+e.c*t),e)},Fu=function(t,e){var n=e._pt,i="";if(!t&&e.b)i=e.b;else if(t===1&&e.e)i=e.e;else{for(;n;)i=n.p+(n.m?n.m(n.s+n.c*t):Math.round((n.s+n.c*t)*1e4)/1e4)+i,n=n._next;i+=e.c}e.set(e.t,e.p,i,e)},pl=function(t,e){for(var n=e._pt;n;)n.r(t,n.d),n=n._next},F0=function(t,e,n,i){for(var r=this._pt,a;r;)a=r._next,r.p===i&&r.modifier(t,e,n),r=a},O0=function(t){for(var e=this._pt,n,i;e;)i=e._next,e.p===t&&!e.op||e.op===t?wa(this,e,"_pt"):e.dep||(n=1),e=i;return!n},B0=function(t,e,n,i){i.mSet(t,e,i.m.call(i.tween,n,i.mt),i)},Ou=function(t){for(var e=t._pt,n,i,r,a;e;){for(n=e._next,i=r;i&&i.pr>e.pr;)i=i._next;(e._prev=i?i._prev:a)?e._prev._next=e:r=e,(e._next=i)?i._prev=e:a=e,e=n}t._pt=r},un=function(){function s(e,n,i,r,a,o,l,h,c){this.t=n,this.s=r,this.c=a,this.p=i,this.r=o||Uu,this.d=l||this,this.set=h||dl,this.pr=c||0,this._next=e,e&&(e._prev=this)}var t=s.prototype;return t.modifier=function(n,i,r){this.mSet=this.mSet||this.set,this.set=B0,this.m=n,this.mt=r,this.tween=i},s}();hn(ll+"parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger",function(s){return ol[s]=1});Sn.TweenMax=Sn.TweenLite=Oe;Sn.TimelineLite=Sn.TimelineMax=sn;Ce=new sn({sortChildren:!1,defaults:Vr,autoRemoveChildren:!0,id:"root",smoothChildTiming:!0});Mn.stringFilter=Au;var Qi=[],ra={},z0=[],rh=0,V0=0,po=function(t){return(ra[t]||z0).map(function(e){return e()})},zo=function(){var t=Date.now(),e=[];t-rh>2&&(po("matchMediaInit"),Qi.forEach(function(n){var i=n.queries,r=n.conditions,a,o,l,h;for(o in i)a=Hn.matchMedia(i[o]).matches,a&&(l=1),a!==r[o]&&(r[o]=a,h=1);h&&(n.revert(),l&&e.push(n))}),po("matchMediaRevert"),e.forEach(function(n){return n.onMatch(n,function(i){return n.add(null,i)})}),rh=t,po("matchMedia"))},Bu=function(){function s(e,n){this.selector=n&&Fo(n),this.data=[],this._r=[],this.isReverted=!1,this.id=V0++,e&&this.add(e)}var t=s.prototype;return t.add=function(n,i,r){Le(n)&&(r=i,i=n,n=Le);var a=this,o=function(){var h=Ae,c=a.selector,u;return h&&h!==a&&h.data.push(a),r&&(a.selector=Fo(r)),Ae=a,u=i.apply(a,arguments),Le(u)&&a._r.push(u),Ae=h,a.selector=c,a.isReverted=!1,u};return a.last=o,n===Le?o(a,function(l){return a.add(null,l)}):n?a[n]=o:o},t.ignore=function(n){var i=Ae;Ae=null,n(this),Ae=i},t.getTweens=function(){var n=[];return this.data.forEach(function(i){return i instanceof s?n.push.apply(n,i.getTweens()):i instanceof Oe&&!(i.parent&&i.parent.data==="nested")&&n.push(i)}),n},t.clear=function(){this._r.length=this.data.length=0},t.kill=function(n,i){var r=this;if(n?function(){for(var o=r.getTweens(),l=r.data.length,h;l--;)h=r.data[l],h.data==="isFlip"&&(h.revert(),h.getChildren(!0,!0,!1).forEach(function(c){return o.splice(o.indexOf(c),1)}));for(o.map(function(c){return{g:c._dur||c._delay||c._sat&&!c._sat.vars.immediateRender?c.globalTime(0):-1/0,t:c}}).sort(function(c,u){return u.g-c.g||-1/0}).forEach(function(c){return c.t.revert(n)}),l=r.data.length;l--;)h=r.data[l],h instanceof sn?h.data!=="nested"&&(h.scrollTrigger&&h.scrollTrigger.revert(),h.kill()):!(h instanceof Oe)&&h.revert&&h.revert(n);r._r.forEach(function(c){return c(n,r)}),r.isReverted=!0}():this.data.forEach(function(o){return o.kill&&o.kill()}),this.clear(),i)for(var a=Qi.length;a--;)Qi[a].id===this.id&&Qi.splice(a,1)},t.revert=function(n){this.kill(n||{})},s}(),k0=function(){function s(e){this.contexts=[],this.scope=e,Ae&&Ae.data.push(this)}var t=s.prototype;return t.add=function(n,i,r){Zn(n)||(n={matches:n});var a=new Bu(0,r||this.scope),o=a.conditions={},l,h,c;Ae&&!a.selector&&(a.selector=Ae.selector),this.contexts.push(a),i=a.add("onMatch",i),a.queries=n;for(h in n)h==="all"?c=1:(l=Hn.matchMedia(n[h]),l&&(Qi.indexOf(a)<0&&Qi.push(a),(o[h]=l.matches)&&(c=1),l.addListener?l.addListener(zo):l.addEventListener("change",zo)));return c&&i(a,function(u){return a.add(null,u)}),this},t.revert=function(n){this.kill(n||{})},t.kill=function(n){this.contexts.forEach(function(i){return i.kill(n,!0)})},s}(),ma={registerPlugin:function(){for(var t=arguments.length,e=new Array(t),n=0;n<t;n++)e[n]=arguments[n];e.forEach(function(i){return Su(i)})},timeline:function(t){return new sn(t)},getTweensOf:function(t,e){return Ce.getTweensOf(t,e)},getProperty:function(t,e,n,i){qe(t)&&(t=Ln(t)[0]);var r=Ki(t||{}).get,a=n?hu:cu;return n==="native"&&(n=""),t&&(e?a((xn[e]&&xn[e].get||r)(t,e,n,i)):function(o,l,h){return a((xn[o]&&xn[o].get||r)(t,o,l,h))})},quickSetter:function(t,e,n){if(t=Ln(t),t.length>1){var i=t.map(function(c){return fn.quickSetter(c,e,n)}),r=i.length;return function(c){for(var u=r;u--;)i[u](c)}}t=t[0]||{};var a=xn[e],o=Ki(t),l=o.harness&&(o.harness.aliases||{})[e]||e,h=a?function(c){var u=new a;Pr._pt=0,u.init(t,n?c+n:c,Pr,0,[t]),u.render(1,u),Pr._pt&&pl(1,Pr)}:o.set(t,l);return a?h:function(c){return h(t,l,n?c+n:c,o,1)}},quickTo:function(t,e,n){var i,r=fn.to(t,ir((i={},i[e]="+=0.1",i.paused=!0,i),n||{})),a=function(l,h,c){return r.resetTo(e,l,h,c)};return a.tween=r,a},isTweening:function(t){return Ce.getTweensOf(t,!0).length>0},defaults:function(t){return t&&t.ease&&(t.ease=Ji(t.ease,Vr.ease)),Qc(Vr,t||{})},config:function(t){return Qc(Mn,t||{})},registerEffect:function(t){var e=t.name,n=t.effect,i=t.plugins,r=t.defaults,a=t.extendTimeline;(i||"").split(",").forEach(function(o){return o&&!xn[o]&&!Sn[o]&&ms(e+" effect requires "+o+" plugin.")}),co[e]=function(o,l,h){return n(Ln(o),In(l||{},r),h)},a&&(sn.prototype[e]=function(o,l,h){return this.add(co[e](o,Zn(l)?l:(h=l)&&{},this),h)})},registerEase:function(t,e){pe[t]=Ji(e)},parseEase:function(t,e){return arguments.length?Ji(t,e):pe},getById:function(t){return Ce.getById(t)},exportRoot:function(t,e){t===void 0&&(t={});var n=new sn(t),i,r;for(n.smoothChildTiming=cn(t.smoothChildTiming),Ce.remove(n),n._dp=0,n._time=n._tTime=Ce._time,i=Ce._first;i;)r=i._next,(e||!(!i._dur&&i instanceof Oe&&i.vars.onComplete===i._targets[0]))&&Xn(n,i,i._start-i._delay),i=r;return Xn(Ce,n,0),n},context:function(t,e){return t?new Bu(t,e):Ae},matchMedia:function(t){return new k0(t)},matchMediaRefresh:function(){return Qi.forEach(function(t){var e=t.conditions,n,i;for(i in e)e[i]&&(e[i]=!1,n=1);n&&t.revert()})||zo()},addEventListener:function(t,e){var n=ra[t]||(ra[t]=[]);~n.indexOf(e)||n.push(e)},removeEventListener:function(t,e){var n=ra[t],i=n&&n.indexOf(e);i>=0&&n.splice(i,1)},utils:{wrap:x0,wrapYoyo:y0,distribute:gu,random:xu,snap:_u,normalize:_0,getUnit:Ze,clamp:p0,splitColor:wu,toArray:Ln,selector:Fo,mapRange:Eu,pipe:v0,unitize:g0,interpolate:E0,shuffle:vu},install:ru,effects:co,ticker:yn,updateRoot:sn.updateRoot,plugins:xn,globalTimeline:Ce,core:{PropTween:un,globals:su,Tween:Oe,Timeline:sn,Animation:xs,getCache:Ki,_removeLinkedListItem:wa,reverting:function(){return Qe},context:function(t){return t&&Ae&&(Ae.data.push(t),t._ctx=Ae),Ae},suppressOverwrites:function(t){return nl=t}}};hn("to,from,fromTo,delayedCall,set,killTweensOf",function(s){return ma[s]=Oe[s]});yn.add(sn.updateRoot);Pr=ma.to({},{duration:0});var H0=function(t,e){for(var n=t._pt;n&&n.p!==e&&n.op!==e&&n.fp!==e;)n=n._next;return n},G0=function(t,e){var n=t._targets,i,r,a;for(i in e)for(r=n.length;r--;)a=t._ptLookup[r][i],a&&(a=a.d)&&(a._pt&&(a=H0(a,i)),a&&a.modifier&&a.modifier(e[i],t,n[r],i))},mo=function(t,e){return{name:t,rawVars:1,init:function(i,r,a){a._onInit=function(o){var l,h;if(qe(r)&&(l={},hn(r,function(c){return l[c]=1}),r=l),e){l={};for(h in r)l[h]=e(r[h]);r=l}G0(o,r)}}}},fn=ma.registerPlugin({name:"attr",init:function(t,e,n,i,r){var a,o,l;this.tween=n;for(a in e)l=t.getAttribute(a)||"",o=this.add(t,"setAttribute",(l||0)+"",e[a],i,r,0,0,a),o.op=a,o.b=l,this._props.push(a)},render:function(t,e){for(var n=e._pt;n;)Qe?n.set(n.t,n.p,n.b,n):n.r(t,n.d),n=n._next}},{name:"endArray",init:function(t,e){for(var n=e.length;n--;)this.add(t,n,t[n]||0,e[n],0,0,0,0,0,1)}},mo("roundProps",Oo),mo("modifiers"),mo("snap",_u))||ma;Oe.version=sn.version=fn.version="3.12.5";iu=1;rl()&&Gr();pe.Power0;pe.Power1;pe.Power2;pe.Power3;pe.Power4;pe.Linear;pe.Quad;pe.Cubic;pe.Quart;pe.Quint;pe.Strong;pe.Elastic;pe.Back;pe.SteppedEase;pe.Bounce;pe.Sine;pe.Expo;pe.Circ;/*!
 * CSSPlugin 3.12.5
 * https://gsap.com
 *
 ...
 * Club GSAP members, the agreement issued with that membership.
 * @author: Jack Doyle, jack@greensock.com
*/var sh,Si,Nr,ml,qi,ah,vl,W0=function(){return typeof window<"u"},ui={},Gi=180/Math.PI,Ur=Math.PI/180,Ar=Math.atan2,oh=1e8,gl=/([A-Z])/g,X0=/(left|right|width|margin|padding|x)/i,q0=/[\s,\(]\S/,qn={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},Vo=function(t,e){return e.set(e.t,e.p,Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},Y0=function(t,e){return e.set(e.t,e.p,t===1?e.e:Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},$0=function(t,e){return e.set(e.t,e.p,t?Math.round((e.s+e.c*t)*1e4)/1e4+e.u:e.b,e)},j0=function(t,e){var n=e.s+e.c*t;e.set(e.t,e.p,~~(n+(n<0?-.5:.5))+e.u,e)},zu=function(t,e){return e.set(e.t,e.p,t?e.e:e.b,e)},Vu=function(t,e){return e.set(e.t,e.p,t!==1?e.b:e.e,e)},K0=function(t,e,n){return t.style[e]=n},Z0=function(t,e,n){return t.style.setProperty(e,n)},J0=function(t,e,n){return t._gsap[e]=n},Q0=function(t,e,n){return t._gsap.scaleX=t._gsap.scaleY=n},tx=function(t,e,n,i,r){var a=t._gsap;a.scaleX=a.scaleY=n,a.renderTransform(r,a)},ex=function(t,e,n,i,r){var a=t._gsap;a[e]=n,a.renderTransform(r,a)},Re="transform",dn=Re+"Origin",nx=function s(t,e){var n=this,i=this.target,r=i.style,a=i._gsap;if(t in ui&&r){if(this.tfm=this.tfm||{},t!=="transform")t=qn[t]||t,~t.indexOf(",")?t.split(",").forEach(function(o){return n.tfm[o]=ai(i,o)}):this.tfm[t]=a.x?a[t]:ai(i,t),t===dn&&(this.tfm.zOrigin=a.zOrigin);else return qn.transform.split(",").forEach(function(o){return s.call(n,o,e)});if(this.props.indexOf(Re)>=0)return;a.svg&&(this.svgo=i.getAttribute("data-svg-origin"),this.props.push(dn,e,"")),t=Re}(r||e)&&this.props.push(t,e,r[t])},ku=function(t){t.translate&&(t.removeProperty("translate"),t.removeProperty("scale"),t.removeProperty("rotate"))},ix=function(){var t=this.props,e=this.target,n=e.style,i=e._gsap,r,a;for(r=0;r<t.length;r+=3)t[r+1]?e[t[r]]=t[r+2]:t[r+2]?n[t[r]]=t[r+2]:n.removeProperty(t[r].substr(0,2)==="--"?t[r]:t[r].replace(gl,"-$1").toLowerCase());if(this.tfm){for(a in this.tfm)i[a]=this.tfm[a];i.svg&&(i.renderTransform(),e.setAttribute("data-svg-origin",this.svgo||"")),r=vl(),(!r||!r.isStart)&&!n[Re]&&(ku(n),i.zOrigin&&n[dn]&&(n[dn]+=" "+i.zOrigin+"px",i.zOrigin=0,i.renderTransform()),i.uncache=1)}},Hu=function(t,e){var n={target:t,props:[],revert:ix,save:nx};return t._gsap||fn.core.getCache(t),e&&e.split(",").forEach(function(i){return n.save(i)}),n},Gu,ko=function(t,e){var n=Si.createElementNS?Si.createElementNS((e||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),t):Si.createElement(t);return n&&n.style?n:Si.createElement(t)},Kn=function s(t,e,n){var i=getComputedStyle(t);return i[e]||i.getPropertyValue(e.replace(gl,"-$1").toLowerCase())||i.getPropertyValue(e)||!n&&s(t,Wr(e)||e,1)||""},lh="O,Moz,ms,Ms,Webkit".split(","),Wr=function(t,e,n){var i=e||qi,r=i.style,a=5;if(t in r&&!n)return t;for(t=t.charAt(0).toUpperCase()+t.substr(1);a--&&!(lh[a]+t in r););return a<0?null:(a===3?"ms":a>=0?lh[a]:"")+t},Ho=function(){W0()&&window.document&&(sh=window,Si=sh.document,Nr=Si.documentElement,qi=ko("div")||{style:{}},ko("div"),Re=Wr(Re),dn=Re+"Origin",qi.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",Gu=!!Wr("perspective"),vl=fn.core.reverting,ml=1)},vo=function s(t){var e=ko("svg",this.ownerSVGElement&&this.ownerSVGElement.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),n=this.parentNode,i=this.nextSibling,r=this.style.cssText,a;if(Nr.appendChild(e),e.appendChild(this),this.style.display="block",t)try{a=this.getBBox(),this._gsapBBox=this.getBBox,this.getBBox=s}catch{}else this._gsapBBox&&(a=this._gsapBBox());return n&&(i?n.insertBefore(this,i):n.appendChild(this)),Nr.removeChild(e),this.style.cssText=r,a},ch=function(t,e){for(var n=e.length;n--;)if(t.hasAttribute(e[n]))return t.getAttribute(e[n])},Wu=function(t){var e;try{e=t.getBBox()}catch{e=vo.call(t,!0)}return e&&(e.width||e.height)||t.getBBox===vo||(e=vo.call(t,!0)),e&&!e.width&&!e.x&&!e.y?{x:+ch(t,["x","cx","x1"])||0,y:+ch(t,["y","cy","y1"])||0,width:0,height:0}:e},Xu=function(t){return!!(t.getCTM&&(!t.parentNode||t.ownerSVGElement)&&Wu(t))},rr=function(t,e){if(e){var n=t.style,i;e in ui&&e!==dn&&(e=Re),n.removeProperty?(i=e.substr(0,2),(i==="ms"||e.substr(0,6)==="webkit")&&(e="-"+e),n.removeProperty(i==="--"?e:e.replace(gl,"-$1").toLowerCase())):n.removeAttribute(e)}},wi=function(t,e,n,i,r,a){var o=new un(t._pt,e,n,0,1,a?Vu:zu);return t._pt=o,o.b=i,o.e=r,t._props.push(n),o},hh={deg:1,rad:1,turn:1},rx={grid:1,flex:1},Di=function s(t,e,n,i){var r=parseFloat(n)||0,a=(n+"").trim().substr((r+"").length)||"px",o=qi.style,l=X0.test(e),h=t.tagName.toLowerCase()==="svg",c=(h?"client":"offset")+(l?"Width":"Height"),u=100,d=i==="px",f=i==="%",v,g,m,p;if(i===a||!r||hh[i]||hh[a])return r;if(a!=="px"&&!d&&(r=s(t,e,n,"px")),p=t.getCTM&&Xu(t),(f||a==="%")&&(ui[e]||~e.indexOf("adius")))return v=p?t.getBBox()[l?"width":"height"]:t[c],Ne(f?r/v*u:r/100*v);if(o[l?"width":"height"]=u+(d?a:i),g=~e.indexOf("adius")||i==="em"&&t.appendChild&&!h?t:t.parentNode,p&&(g=(t.ownerSVGElement||{}).parentNode),(!g||g===Si||!g.appendChild)&&(g=Si.body),m=g._gsap,m&&f&&m.width&&l&&m.time===yn.time&&!m.uncache)return Ne(r/m.width*u);if(f&&(e==="height"||e==="width")){var _=t.style[e];t.style[e]=u+i,v=t[c],_?t.style[e]=_:rr(t,e)}else(f||a==="%")&&!rx[Kn(g,"display")]&&(o.position=Kn(t,"position")),g===t&&(o.position="static"),g.appendChild(qi),v=qi[c],g.removeChild(qi),o.position="absolute";return l&&f&&(m=Ki(g),m.time=yn.time,m.width=g[c]),Ne(d?v*r/u:v&&r?u/v*r:0)},ai=function(t,e,n,i){var r;return ml||Ho(),e in qn&&e!=="transform"&&(e=qn[e],~e.indexOf(",")&&(e=e.split(",")[0])),ui[e]&&e!=="transform"?(r=Es(t,i),r=e!=="transformOrigin"?r[e]:r.svg?r.origin:ga(Kn(t,dn))+" "+r.zOrigin+"px"):(r=t.style[e],(!r||r==="auto"||i||~(r+"").indexOf("calc("))&&(r=va[e]&&va[e](t,e,n)||Kn(t,e)||ou(t,e)||(e==="opacity"?1:0))),n&&!~(r+"").trim().indexOf(" ")?Di(t,e,r,n)+n:r},sx=function(t,e,n,i){if(!n||n==="none"){var r=Wr(e,t,1),a=r&&Kn(t,r,1);a&&a!==n?(e=r,n=a):e==="borderColor"&&(n=Kn(t,"borderTopColor"))}var o=new un(this._pt,t.style,e,0,1,Fu),l=0,h=0,c,u,d,f,v,g,m,p,_,x,y,E;if(o.b=n,o.e=i,n+="",i+="",i==="auto"&&(g=t.style[e],t.style[e]=i,i=Kn(t,e)||i,g?t.style[e]=g:rr(t,e)),c=[n,i],Au(c),n=c[0],i=c[1],d=n.match(Rr)||[],E=i.match(Rr)||[],E.length){for(;u=Rr.exec(i);)m=u[0],_=i.substring(l,u.index),v?v=(v+1)%5:(_.substr(-5)==="rgba("||_.substr(-5)==="hsla(")&&(v=1),m!==(g=d[h++]||"")&&(f=parseFloat(g)||0,y=g.substr((f+"").length),m.charAt(1)==="="&&(m=Ir(f,m)+y),p=parseFloat(m),x=m.substr((p+"").length),l=Rr.lastIndex-x.length,x||(x=x||Mn.units[e]||y,l===i.length&&(i+=x,o.e+=x)),y!==x&&(f=Di(t,e,g,x)||0),o._pt={_next:o._pt,p:_||h===1?_:",",s:f,c:p-f,m:v&&v<4||e==="zIndex"?Math.round:0});o.c=l<i.length?i.substring(l,i.length):""}else o.r=e==="display"&&i==="none"?Vu:zu;return eu.test(i)&&(o.e=0),this._pt=o,o},uh={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},ax=function(t){var e=t.split(" "),n=e[0],i=e[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(t=n,n=i,i=t),e[0]=uh[n]||n,e[1]=uh[i]||i,e.join(" ")},ox=function(t,e){if(e.tween&&e.tween._time===e.tween._dur){var n=e.t,i=n.style,r=e.u,a=n._gsap,o,l,h;if(r==="all"||r===!0)i.cssText="",l=1;else for(r=r.split(","),h=r.length;--h>-1;)o=r[h],ui[o]&&(l=1,o=o==="transformOrigin"?dn:Re),rr(n,o);l&&(rr(n,Re),a&&(a.svg&&n.removeAttribute("transform"),Es(n,1),a.uncache=1,ku(i)))}},va={clearProps:function(t,e,n,i,r){if(r.data!=="isFromStart"){var a=t._pt=new un(t._pt,e,n,0,0,ox);return a.u=i,a.pr=-10,a.tween=r,t._props.push(n),1}}},ys=[1,0,0,1,0,0],qu={},Yu=function(t){return t==="matrix(1, 0, 0, 1, 0, 0)"||t==="none"||!t},dh=function(t){var e=Kn(t,Re);return Yu(e)?ys:e.substr(7).match(tu).map(Ne)},_l=function(t,e){var n=t._gsap||Ki(t),i=t.style,r=dh(t),a,o,l,h;return n.svg&&t.getAttribute("transform")?(l=t.transform.baseVal.consolidate().matrix,r=[l.a,l.b,l.c,l.d,l.e,l.f],r.join(",")==="1,0,0,1,0,0"?ys:r):(r===ys&&!t.offsetParent&&t!==Nr&&!n.svg&&(l=i.display,i.display="block",a=t.parentNode,(!a||!t.offsetParent)&&(h=1,o=t.nextElementSibling,Nr.appendChild(t)),r=dh(t),l?i.display=l:rr(t,"display"),h&&(o?a.insertBefore(t,o):a?a.appendChild(t):Nr.removeChild(t))),e&&r.length>6?[r[0],r[1],r[4],r[5],r[12],r[13]]:r)},Go=function(t,e,n,i,r,a){var o=t._gsap,l=r||_l(t,!0),h=o.xOrigin||0,c=o.yOrigin||0,u=o.xOffset||0,d=o.yOffset||0,f=l[0],v=l[1],g=l[2],m=l[3],p=l[4],_=l[5],x=e.split(" "),y=parseFloat(x[0])||0,E=parseFloat(x[1])||0,A,b,R,M;n?l!==ys&&(b=f*m-v*g)&&(R=y*(m/b)+E*(-g/b)+(g*_-m*p)/b,M=y*(-v/b)+E*(f/b)-(f*_-v*p)/b,y=R,E=M):(A=Wu(t),y=A.x+(~x[0].indexOf("%")?y/100*A.width:y),E=A.y+(~(x[1]||x[0]).indexOf("%")?E/100*A.height:E)),i||i!==!1&&o.smooth?(p=y-h,_=E-c,o.xOffset=u+(p*f+_*g)-p,o.yOffset=d+(p*v+_*m)-_):o.xOffset=o.yOffset=0,o.xOrigin=y,o.yOrigin=E,o.smooth=!!i,o.origin=e,o.originIsAbsolute=!!n,t.style[dn]="0px 0px",a&&(wi(a,o,"xOrigin",h,y),wi(a,o,"yOrigin",c,E),wi(a,o,"xOffset",u,o.xOffset),wi(a,o,"yOffset",d,o.yOffset)),t.setAttribute("data-svg-origin",y+" "+E)},Es=function(t,e){var n=t._gsap||new Pu(t);if("x"in n&&!e&&!n.uncache)return n;var i=t.style,r=n.scaleX<0,a="px",o="deg",l=getComputedStyle(t),h=Kn(t,dn)||"0",c,u,d,f,v,g,m,p,_,x,y,E,A,b,R,M,S,P,z,V,N,k,J,F,B,q,X,T,O,U,D,L;return c=u=d=g=m=p=_=x=y=0,f=v=1,n.svg=!!(t.getCTM&&Xu(t)),l.translate&&((l.translate!=="none"||l.scale!=="none"||l.rotate!=="none")&&(i[Re]=(l.translate!=="none"?"translate3d("+(l.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(l.rotate!=="none"?"rotate("+l.rotate+") ":"")+(l.scale!=="none"?"scale("+l.scale.split(" ").join(",")+") ":"")+(l[Re]!=="none"?l[Re]:"")),i.scale=i.rotate=i.translate="none"),b=_l(t,n.svg),n.svg&&(n.uncache?(B=t.getBBox(),h=n.xOrigin-B.x+"px "+(n.yOrigin-B.y)+"px",F=""):F=!e&&t.getAttribute("data-svg-origin"),Go(t,F||h,!!F||n.originIsAbsolute,n.smooth!==!1,b)),E=n.xOrigin||0,A=n.yOrigin||0,b!==ys&&(P=b[0],z=b[1],V=b[2],N=b[3],c=k=b[4],u=J=b[5],b.length===6?(f=Math.sqrt(P*P+z*z),v=Math.sqrt(N*N+V*V),g=P||z?Ar(z,P)*Gi:0,_=V||N?Ar(V,N)*Gi+g:0,_&&(v*=Math.abs(Math.cos(_*Ur))),n.svg&&(c-=E-(E*P+A*V),u-=A-(E*z+A*N))):(L=b[6],U=b[7],X=b[8],T=b[9],O=b[10],D=b[11],c=b[12],u=b[13],d=b[14],R=Ar(L,O),m=R*Gi,R&&(M=Math.cos(-R),S=Math.sin(-R),F=k*M+X*S,B=J*M+T*S,q=L*M+O*S,X=k*-S+X*M,T=J*-S+T*M,O=L*-S+O*M,D=U*-S+D*M,k=F,J=B,L=q),R=Ar(-V,O),p=R*Gi,R&&(M=Math.cos(-R),S=Math.sin(-R),F=P*M-X*S,B=z*M-T*S,q=V*M-O*S,D=N*S+D*M,P=F,z=B,V=q),R=Ar(z,P),g=R*Gi,R&&(M=Math.cos(R),S=Math.sin(R),F=P*M+z*S,B=k*M+J*S,z=z*M-P*S,J=J*M-k*S,P=F,k=B),m&&Math.abs(m)+Math.abs(g)>359.9&&(m=g=0,p=180-p),f=Ne(Math.sqrt(P*P+z*z+V*V)),v=Ne(Math.sqrt(J*J+L*L)),R=Ar(k,J),_=Math.abs(R)>2e-4?R*Gi:0,y=D?1/(D<0?-D:D):0),n.svg&&(F=t.getAttribute("transform"),n.forceCSS=t.setAttribute("transform","")||!Yu(Kn(t,Re)),F&&t.setAttribute("transform",F))),Math.abs(_)>90&&Math.abs(_)<270&&(r?(f*=-1,_+=g<=0?180:-180,g+=g<=0?180:-180):(v*=-1,_+=_<=0?180:-180)),e=e||n.uncache,n.x=c-((n.xPercent=c&&(!e&&n.xPercent||(Math.round(t.offsetWidth/2)===Math.round(-c)?-50:0)))?t.offsetWidth*n.xPercent/100:0)+a,n.y=u-((n.yPercent=u&&(!e&&n.yPercent||(Math.round(t.offsetHeight/2)===Math.round(-u)?-50:0)))?t.offsetHeight*n.yPercent/100:0)+a,n.z=d+a,n.scaleX=Ne(f),n.scaleY=Ne(v),n.rotation=Ne(g)+o,n.rotationX=Ne(m)+o,n.rotationY=Ne(p)+o,n.skewX=_+o,n.skewY=x+o,n.transformPerspective=y+a,(n.zOrigin=parseFloat(h.split(" ")[2])||!e&&n.zOrigin||0)&&(i[dn]=ga(h)),n.xOffset=n.yOffset=0,n.force3D=Mn.force3D,n.renderTransform=n.svg?cx:Gu?$u:lx,n.uncache=0,n},ga=function(t){return(t=t.split(" "))[0]+" "+t[1]},go=function(t,e,n){var i=Ze(e);return Ne(parseFloat(e)+parseFloat(Di(t,"x",n+"px",i)))+i},lx=function(t,e){e.z="0px",e.rotationY=e.rotationX="0deg",e.force3D=0,$u(t,e)},Vi="0deg",ts="0px",ki=") ",$u=function(t,e){var n=e||this,i=n.xPercent,r=n.yPercent,a=n.x,o=n.y,l=n.z,h=n.rotation,c=n.rotationY,u=n.rotationX,d=n.skewX,f=n.skewY,v=n.scaleX,g=n.scaleY,m=n.transformPerspective,p=n.force3D,_=n.target,x=n.zOrigin,y="",E=p==="auto"&&t&&t!==1||p===!0;if(x&&(u!==Vi||c!==Vi)){var A=parseFloat(c)*Ur,b=Math.sin(A),R=Math.cos(A),M;A=parseFloat(u)*Ur,M=Math.cos(A),a=go(_,a,b*M*-x),o=go(_,o,-Math.sin(A)*-x),l=go(_,l,R*M*-x+x)}m!==ts&&(y+="perspective("+m+ki),(i||r)&&(y+="translate("+i+"%, "+r+"%) "),(E||a!==ts||o!==ts||l!==ts)&&(y+=l!==ts||E?"translate3d("+a+", "+o+", "+l+") ":"translate("+a+", "+o+ki),h!==Vi&&(y+="rotate("+h+ki),c!==Vi&&(y+="rotateY("+c+ki),u!==Vi&&(y+="rotateX("+u+ki),(d!==Vi||f!==Vi)&&(y+="skew("+d+", "+f+ki),(v!==1||g!==1)&&(y+="scale("+v+", "+g+ki),_.style[Re]=y||"translate(0, 0)"},cx=function(t,e){var n=e||this,i=n.xPercent,r=n.yPercent,a=n.x,o=n.y,l=n.rotation,h=n.skewX,c=n.skewY,u=n.scaleX,d=n.scaleY,f=n.target,v=n.xOrigin,g=n.yOrigin,m=n.xOffset,p=n.yOffset,_=n.forceCSS,x=parseFloat(a),y=parseFloat(o),E,A,b,R,M;l=parseFloat(l),h=parseFloat(h),c=parseFloat(c),c&&(c=parseFloat(c),h+=c,l+=c),l||h?(l*=Ur,h*=Ur,E=Math.cos(l)*u,A=Math.sin(l)*u,b=Math.sin(l-h)*-d,R=Math.cos(l-h)*d,h&&(c*=Ur,M=Math.tan(h-c),M=Math.sqrt(1+M*M),b*=M,R*=M,c&&(M=Math.tan(c),M=Math.sqrt(1+M*M),E*=M,A*=M)),E=Ne(E),A=Ne(A),b=Ne(b),R=Ne(R)):(E=u,R=d,A=b=0),(x&&!~(a+"").indexOf("px")||y&&!~(o+"").indexOf("px"))&&(x=Di(f,"x",a,"px"),y=Di(f,"y",o,"px")),(v||g||m||p)&&(x=Ne(x+v-(v*E+g*b)+m),y=Ne(y+g-(v*A+g*R)+p)),(i||r)&&(M=f.getBBox(),x=Ne(x+i/100*M.width),y=Ne(y+r/100*M.height)),M="matrix("+E+","+A+","+b+","+R+","+x+","+y+")",f.setAttribute("transform",M),_&&(f.style[Re]=M)},hx=function(t,e,n,i,r){var a=360,o=qe(r),l=parseFloat(r)*(o&&~r.indexOf("rad")?Gi:1),h=l-i,c=i+h+"deg",u,d;return o&&(u=r.split("_")[1],u==="short"&&(h%=a,h!==h%(a/2)&&(h+=h<0?a:-a)),u==="cw"&&h<0?h=(h+a*oh)%a-~~(h/a)*a:u==="ccw"&&h>0&&(h=(h-a*oh)%a-~~(h/a)*a)),t._pt=d=new un(t._pt,e,n,i,h,Y0),d.e=c,d.u="deg",t._props.push(n),d},fh=function(t,e){for(var n in e)t[n]=e[n];return t},ux=function(t,e,n){var i=fh({},n._gsap),r="perspective,force3D,transformOrigin,svgOrigin",a=n.style,o,l,h,c,u,d,f,v;i.svg?(h=n.getAttribute("transform"),n.setAttribute("transform",""),a[Re]=e,o=Es(n,1),rr(n,Re),n.setAttribute("transform",h)):(h=getComputedStyle(n)[Re],a[Re]=e,o=Es(n,1),a[Re]=h);for(l in ui)h=i[l],c=o[l],h!==c&&r.indexOf(l)<0&&(f=Ze(h),v=Ze(c),u=f!==v?Di(n,l,h,v):parseFloat(h),d=parseFloat(c),t._pt=new un(t._pt,o,l,u,d-u,Vo),t._pt.u=v||0,t._props.push(l));fh(o,i)};hn("padding,margin,Width,Radius",function(s,t){var e="Top",n="Right",i="Bottom",r="Left",a=(t<3?[e,n,i,r]:[e+r,e+n,i+n,i+r]).map(function(o){return t<2?s+o:"border"+o+s});va[t>1?"border"+s:s]=function(o,l,h,c,u){var d,f;if(arguments.length<4)return d=a.map(function(v){return ai(o,v,h)}),f=d.join(" "),f.split(d[0]).length===5?d[0]:f;d=(c+"").split(" "),f={},a.forEach(function(v,g){return f[v]=d[g]=d[g]||d[(g-1)/2|0]}),o.init(l,f,u)}});var ju={name:"css",register:Ho,targetTest:function(t){return t.style&&t.nodeType},init:function(t,e,n,i,r){var a=this._props,o=t.style,l=n.vars.startAt,h,c,u,d,f,v,g,m,p,_,x,y,E,A,b,R;ml||Ho(),this.styles=this.styles||Hu(t),R=this.styles.props,this.tween=n;for(g in e)if(g!=="autoRound"&&(c=e[g],!(xn[g]&&Lu(g,e,n,i,t,r)))){if(f=typeof c,v=va[g],f==="function"&&(c=c.call(n,i,t,r),f=typeof c),f==="string"&&~c.indexOf("random(")&&(c=gs(c)),v)v(this,t,g,c,n)&&(b=1);else if(g.substr(0,2)==="--")h=(getComputedStyle(t).getPropertyValue(g)+"").trim(),c+="",Ri.lastIndex=0,Ri.test(h)||(m=Ze(h),p=Ze(c)),p?m!==p&&(h=Di(t,g,h,p)+p):m&&(c+=m),this.add(o,"setProperty",h,c,i,r,0,0,g),a.push(g),R.push(g,0,o[g]);else if(f!=="undefined"){if(l&&g in l?(h=typeof l[g]=="function"?l[g].call(n,i,t,r):l[g],qe(h)&&~h.indexOf("random(")&&(h=gs(h)),Ze(h+"")||h==="auto"||(h+=Mn.units[g]||Ze(ai(t,g))||""),(h+"").charAt(1)==="="&&(h=ai(t,g))):h=ai(t,g),d=parseFloat(h),_=f==="string"&&c.charAt(1)==="="&&c.substr(0,2),_&&(c=c.substr(2)),u=parseFloat(c),g in qn&&(g==="autoAlpha"&&(d===1&&ai(t,"visibility")==="hidden"&&u&&(d=0),R.push("visibility",0,o.visibility),wi(this,o,"visibility",d?"inherit":"hidden",u?"inherit":"hidden",!u)),g!=="scale"&&g!=="transform"&&(g=qn[g],~g.indexOf(",")&&(g=g.split(",")[0]))),x=g in ui,x){if(this.styles.save(g),y||(E=t._gsap,E.renderTransform&&!e.parseTransform||Es(t,e.parseTransform),A=e.smoothOrigin!==!1&&E.smooth,y=this._pt=new un(this._pt,o,Re,0,1,E.renderTransform,E,0,-1),y.dep=1),g==="scale")this._pt=new un(this._pt,E,"scaleY",E.scaleY,(_?Ir(E.scaleY,_+u):u)-E.scaleY||0,Vo),this._pt.u=0,a.push("scaleY",g),g+="X";else if(g==="transformOrigin"){R.push(dn,0,o[dn]),c=ax(c),E.svg?Go(t,c,0,A,0,this):(p=parseFloat(c.split(" ")[2])||0,p!==E.zOrigin&&wi(this,E,"zOrigin",E.zOrigin,p),wi(this,o,g,ga(h),ga(c)));continue}else if(g==="svgOrigin"){Go(t,c,1,A,0,this);continue}else if(g in qu){hx(this,E,g,d,_?Ir(d,_+c):c);continue}else if(g==="smoothOrigin"){wi(this,E,"smooth",E.smooth,c);continue}else if(g==="force3D"){E[g]=c;continue}else if(g==="transform"){ux(this,c,t);continue}}else g in o||(g=Wr(g)||g);if(x||(u||u===0)&&(d||d===0)&&!q0.test(c)&&g in o)m=(h+"").substr((d+"").length),u||(u=0),p=Ze(c)||(g in Mn.units?Mn.units[g]:m),m!==p&&(d=Di(t,g,h,p)),this._pt=new un(this._pt,x?E:o,g,d,(_?Ir(d,_+u):u)-d,!x&&(p==="px"||g==="zIndex")&&e.autoRound!==!1?j0:Vo),this._pt.u=p||0,m!==p&&p!=="%"&&(this._pt.b=h,this._pt.r=$0);else if(g in o)sx.call(this,t,g,h,_?_+c:c);else if(g in t)this.add(t,g,h||t[g],_?_+c:c,i,r);else if(g!=="parseTransform"){al(g,c);continue}x||(g in o?R.push(g,0,o[g]):R.push(g,1,h||t[g])),a.push(g)}}b&&Ou(this)},render:function(t,e){if(e.tween._time||!vl())for(var n=e._pt;n;)n.r(t,n.d),n=n._next;else e.styles.revert()},get:ai,aliases:qn,getSetter:function(t,e,n){var i=qn[e];return i&&i.indexOf(",")<0&&(e=i),e in ui&&e!==dn&&(t._gsap.x||ai(t,"x"))?n&&ah===n?e==="scale"?Q0:J0:(ah=n||{})&&(e==="scale"?tx:ex):t.style&&!il(t.style[e])?K0:~e.indexOf("-")?Z0:fl(t,e)},core:{_removeProperty:rr,_getMatrix:_l}};fn.utils.checkPrefix=Wr;fn.core.getStyleSaver=Hu;(function(s,t,e,n){var i=hn(s+","+t+","+e,function(r){ui[r]=1});hn(t,function(r){Mn.units[r]="deg",qu[r]=1}),qn[i[13]]=s+","+t,hn(n,function(r){var a=r.split(":");qn[a[1]]=i[a[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");hn("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(s){Mn.units[s]="px"});fn.registerPlugin(ju);var $r=fn.registerPlugin(ju)||fn;$r.core.Tween;const As=new j_({width:200}),$t={},xl=As.addFolder("Camera"),Ku=As.addFolder("Scene"),pn=As.addFolder("Objects"),bs=As.addFolder("World");$t.SCENE_CLEAR_CENTER=()=>{for(let s=0;s<5;s++)Dn.forEach(t=>{if(t.mesh.position.x>=-35&&t.mesh.position.x<=35&&t.mesh.position.y>=-1&&t.mesh.position.y<=400&&t.mesh.position.z>=-35&&t.mesh.position.z<=35){Jn.remove(t.mesh),t.mesh.geometry&&t.mesh.geometry.dispose(),t.mesh.material&&(t.mesh.material.map&&t.mesh.material.map.dispose(),t.mesh.material.dispose()),Ye.remove(t.body);const n=Dn.indexOf(t);n!==-1&&Dn.splice(n,1)}})};$t.SCENE_CLEAR_ALL=()=>{Dn.forEach(s=>{Jn.remove(s.mesh),s.mesh.geometry&&s.mesh.geometry.dispose(),s.mesh.material&&(s.mesh.material.map&&s.mesh.material.map.dispose(),s.mesh.material.dispose()),Ye.remove(s.body)}),Dn.length=0};$t.WORLD_SLEEP_FOR_1SEC=()=>{$t.WORLD_FREEZE(),setTimeout(()=>{Ye.allowSleep=!1},1e3)};$t.WORLD_FREEZE=()=>{Ye.allowSleep=!0,Dn.forEach(({body:s})=>{s.customData||(s.customData={velocity:s.velocity.clone(),angularVelocity:s.angularVelocity.clone(),force:s.force.clone(),torque:s.torque.clone()}),s.sleep()})};$t.WORLD_DENY_SLEEP=()=>{Ye.allowSleep=!1};$t.WORLD_WAKE_UP_CALM=()=>{Ye.allowSleep=!1,Dn.forEach(s=>{s.body.sleepSpeedLimit=.001,s.body.wakeUp()})};$t.WORLD_WAKE_UP_ACTIVE=()=>{Ye.allowSleep=!1,Dn.forEach(({body:s})=>{s.customData&&(s.velocity.copy(s.customData.velocity),s.angularVelocity.copy(s.customData.angularVelocity),s.force.copy(s.customData.force),s.torque.copy(s.customData.torque),s.customData=null),s.sleepSpeedLimit=.001,s.wakeUp()})};$t.CAMERA_STOP_MOVING=()=>{$r.killTweensOf(kn.position)};$t.CAMERA_MOVE_SPIN=()=>{$t.CAMERA_STOP_MOVING(),yl()};$t.CAMERA_MOVE_SPIN_CLOSE=()=>{$t.CAMERA_STOP_MOVING(),yl(2)};$t.SPHERE_VERTICAL_LINE=()=>{for(let s=.5;s<10.5;s++)Ca(.5,{x:0,y:s,z:0})};$t.CUBE_WALL_EXPLOSION_BIG=()=>{let s=0,t=setInterval(()=>{s===8&&clearInterval(t),s+=1;for(let e=-5;e<5;e++)for(let n=1;n<11;n++)fi(1,1,1,{x:e,y:n,z:0})},50)};$t.CUBE_WALL_MEDIUM=()=>{for(let s=-1;s<2;s++)for(let t=-20;t<20;t++)for(let e=.5;e<10.5;e++)fi(1,1,1,{x:t,y:e,z:s})};$t.CUBE_WALL_EXPLOSION_MEDIUM=()=>{let s=0,t=setInterval(()=>{s===4&&clearInterval(t),s+=1;for(let e=-5;e<5;e++)for(let n=1;n<11;n++)fi(1,1,1,{x:e,y:n,z:0})},50);As.close()};$t.createHugeHighTower=()=>{for(let t=-10/2;t<10/2;t++)for(let e=-10/2;e<10/2;e++)for(let n=0;n<10*3;n++)fi(1,1,1,{x:t,y:n+.5,z:e})};$t.CUBE_TOWER_TO_THE_MOON=()=>{for(let t=-16/16;t<16/16;t++)for(let e=-16/16;e<16/16;e++)for(let n=0;n<16*20;n++)fi(.98,.98,.98,{x:t,y:n+.5,z:e})};$t.CUBE_ROTATED_STACK_BIG=()=>{for(let e=0;e<12*10;e++)nd(5*8,1,5*8,{x:0,y:e*2+.5,z:0})};$t.CUBE_ROTATED_STACK_MEDIUM=()=>{for(let e=0;e<10*10;e++)nd(5*6,2,5*6,{x:0,y:e*2+.5,z:0})};$t.CUBE_LITTLE_TOWER=()=>{for(let s=-2;s<2;s++)for(let t=-2;t<2;t++)for(let e=.5;e<26.5;e++)fi(.98,.98,.98,{x:t,y:e,z:s})};$t.CUBE_BOX_BUILDING=()=>{for(let s=-5;s<5;s++)for(let t=-5;t<5;t++)for(let e=.5;e<6.5;e++)fi(.988,.988,.988,{x:t,y:e,z:s})};$t.CUBE_WALL_SMALL_6x10=()=>{for(let s=-5;s<5;s++)for(let t=.5;t<6.5;t++)fi(.988,.988,.988,{x:s,y:t,z:0})};$t.CUBE_WALL_SMALL_10x10=()=>{for(let s=-5;s<5;s++)for(let t=1;t<11;t++)fi(1,1,1,{x:s,y:t,z:0})};$t.SPHERE_WALL_10x20=()=>{for(let s=-5;s<5;s++)for(let t=.5;t<20.5;t++)Ca(.5,{x:s,y:t,z:0})};$t.SPHERE_ABOVE_CENTER=()=>{Ca(.5,{x:0,y:4,z:0})};$t.SPHERE_RANDOM=()=>{Ca(Math.random()*.5*5+.5,{x:(Math.random()-.5)*10,y:3,z:(Math.random()-.5)*10})};xl.add($t,"CAMERA_STOP_MOVING");xl.add($t,"CAMERA_MOVE_SPIN");xl.add($t,"CAMERA_MOVE_SPIN_CLOSE");pn.add($t,"CUBE_TOWER_TO_THE_MOON");pn.add($t,"CUBE_ROTATED_STACK_BIG");pn.add($t,"CUBE_ROTATED_STACK_MEDIUM");pn.add($t,"CUBE_LITTLE_TOWER");pn.add($t,"CUBE_BOX_BUILDING");pn.add($t,"CUBE_WALL_MEDIUM");pn.add($t,"CUBE_WALL_SMALL_6x10");pn.add($t,"CUBE_WALL_EXPLOSION_MEDIUM");pn.add($t,"CUBE_WALL_EXPLOSION_BIG");pn.add($t,"CUBE_WALL_SMALL_10x10");pn.add($t,"SPHERE_WALL_10x20");pn.add($t,"SPHERE_VERTICAL_LINE");pn.add($t,"SPHERE_ABOVE_CENTER");pn.add($t,"SPHERE_RANDOM");bs.add($t,"WORLD_SLEEP_FOR_1SEC");bs.add($t,"WORLD_FREEZE");bs.add($t,"WORLD_DENY_SLEEP");bs.add($t,"WORLD_WAKE_UP_CALM");bs.add($t,"WORLD_WAKE_UP_ACTIVE");Ku.add($t,"SCENE_CLEAR_CENTER");Ku.add($t,"SCENE_CLEAR_ALL");const Zu=document.querySelector("canvas.webgl"),Jn=new T_,Ju=new R_;new C_;const Wo=Ju.load("/assets/ground.jpg");console.log("groundTexture");console.log(Wo);const dx=Ju.load(Xo(()=>import("./ground-4d35bfb4.js"),[],import.meta.url));console.log("groundTexture2");console.log(dx);const fx=Xo(()=>import("./ground-4d35bfb4.js"),[],import.meta.url);console.log("imgTest");console.log(fx);const px=Xo(()=>import("./ground-4d35bfb4.js"),[],import.meta.url);console.log("imgTest2");console.log(px);const Ye=new an.World;Ye.broadphase=new an.SAPBroadphase(Ye);Ye.gravity.set(0,-9.82,0);Ye.solver.tolerance=.01;new Audio("/sounds/hit.mp3");const Ms=new an.Material("default"),Qu=new an.ContactMaterial(Ms,Ms,{friction:.3,restitution:.7});Ye.addContactMaterial(Qu);Ye.defaultContactMaterial=Qu;const mx=new an.Plane,Ui=new an.Body;Ui.mass=0;Ui.position=new an.Vec3(0,0,0);Ui.addShape(mx);Ui.quaternion.setFromEuler(Math.PI*.5/-1,0,0);Ye.addBody(Ui);const jr=new Rn(new Ea(70,70),new Yh({color:"#777777",metalness:.3,roughness:.4,map:Wo,transparent:!0,alphaMap:Wo,opacity:2}));jr.receiveShadow=!1;jr.rotation.x=-Math.PI*.5;jr.position.copy(Ui.position);jr.quaternion.copy(Ui.quaternion);Jn.add(jr);const vx=new I_(16777215,2.1);Jn.add(vx);const di=new D_(16777215,.6);di.castShadow=!1;di.shadow.mapSize.set(1024,1024);di.shadow.camera.far=15;di.shadow.camera.left=-7;di.shadow.camera.top=7;di.shadow.camera.right=7;di.shadow.camera.bottom=-7;di.position.set(5,5,5);Jn.add(di);const Wn={width:window.innerWidth,height:window.innerHeight};window.addEventListener("resize",()=>{Wn.width=window.innerWidth,Wn.height=window.innerHeight,kn.aspect=Wn.width/Wn.height,kn.updateProjectionMatrix(),sr.setSize(Wn.width,Wn.height),sr.setPixelRatio(Math.min(window.devicePixelRatio,2))});const kn=new bn(95,Wn.width/Wn.height,.01,2e3);kn.position.set(-5,70,90);Jn.add(kn);const ba=5;function gx(s){const t=s||1;$r.to(kn.position,{duration:ba,x:150*3/t,y:-50*3/t,z:200/t,ease:"power1.inOut",onComplete:function(){yl(t)}})}function _x(s){const t=s||1;$r.to(kn.position,{duration:ba,x:0,y:200*3/t,z:-150*3/t,ease:"power1.inOut",onComplete:function(){gx(t)}})}function xx(s){const t=s||1;$r.to(kn.position,{duration:ba,x:-100*3/t,y:150*3/t,z:0,ease:"power1.inOut",onComplete:function(){_x(t)}})}function yl(s=0){const t=s||1;$r.to(kn.position,{duration:ba,x:-3,y:200*3/t,z:150*3/t,ease:"power1.inOut",onComplete:function(){xx(t)}})}const td=new F_(kn,Zu);td.enableDamping=!0;const sr=new qh({canvas:Zu});sr.shadowMap.enabled=!0;sr.shadowMap.type=gh;sr.setSize(Wn.width,Wn.height);sr.setPixelRatio(Math.min(window.devicePixelRatio,2));const Dn=[],ed=new qr(1,1,1),El=new Yh({metalness:.3,roughness:.4,wireframe:!0}),fi=(s=.8,t=.8,e=.8,n)=>{const i=new Rn(ed,El);i.scale.set(s,t,e),i.castShadow=!1,i.position.copy(n),Jn.add(i);const r=new an.Box(new an.Vec3(s/2,t/2,e/2)),a=new an.Body({mass:1,shape:r,material:Ms});a.position.copy(n),Ye.addBody(a),Dn.push({mesh:i,body:a})};let _o=1;const nd=(s=1,t=1,e=1,n)=>{console.log("rotateYDegree");const i=new Rn(ed,El);i.scale.set(s,t,e),i.castShadow=!1,i.position.copy(n),i.rotation.set(0,_o*(Math.PI/180),0),Jn.add(i);const r=new an.Box(new an.Vec3(s/2,t/2,e/2)),a=new an.Body({mass:1,shape:r,material:Ms});a.position.copy(n),a.quaternion.setFromEuler(0,_o*(Math.PI/180),0),_o+=.5,Ye.addBody(a),Dn.push({mesh:i,body:a})},yx=new tl(1,20,20),Ca=(s,t)=>{const e=new Rn(yx,El);e.scale.set(s,s,s),e.castShadow=!1,e.position.copy(t),Jn.add(e);const n=new an.Sphere(s),i=new an.Body({mass:1,shape:n,material:Ms});i.position.copy(t),Ye.addBody(i),Dn.push({mesh:e,body:i})},Ex=new N_;let ph=0;const id=()=>{const s=Ex.getElapsedTime(),t=s-ph;ph=s,Ye.step(1/60,t,3);for(const e of Dn)e.mesh.position.copy(e.body.position),e.mesh.quaternion.copy(e.body.quaternion);jr.position.copy(Ui.position),td.update(),sr.render(Jn,kn),window.requestAnimationFrame(id)};id();const Mx=s=>{(s.key==="P"||s.key==="p")&&$t.WORLD_FREEZE(),(s.key==="O"||s.key==="o")&&$t.WORLD_WAKE_UP_ACTIVE(),(s.key==="C"||s.key==="c")&&$t.SCENE_CLEAR_ALL(),(s.key==="L"||s.key==="l")&&$t.WORLD_WAKE_UP_CALM(),(s.key==="M"||s.key==="m")&&$t.CAMERA_MOVE_SPIN(),(s.key==="N"||s.key==="n")&&$t.CAMERA_STOP_MOVING(),(s.key==="B"||s.key==="b")&&$t.CAMERA_MOVE_SPIN_CLOSE(),(s.key==="G"||s.key==="g")&&$t.CUBE_ROTATED_STACK_BIG(),(s.key==="H"||s.key==="h")&&$t.CUBE_ROTATED_STACK_MEDIUM(),(s.key==="J"||s.key==="j")&&$t.CUBE_LITTLE_TOWER(),s.altKey&&s.key==="C"&&$t.SCENE_CLEAR_CENTER(),document.body.focus()};document.body.setAttribute("tabindex","1");window.document.addEventListener("keydown",Mx);let mh=window.document.querySelectorAll(".lil-gui .children .controller"),Me=window.document.querySelectorAll(".lil-gui .children .name");for(var _e=0;_e<mh.length;_e++)mh[_e].classList.add("hoverMarkable");document.body.setAttribute("tabindex","1");for(var _e=0;_e<Me.length;_e++)Me[_e].classList.add("addTip"),Me[_e].textContent==="SCENE_CLEAR_CENTER"&&Me[_e].classList.add("addTipAltC"),Me[_e].textContent==="SCENE_CLEAR_ALL"&&Me[_e].classList.add("addTipC"),Me[_e].textContent==="WORLD_FREEZE"&&Me[_e].classList.add("addTipP"),Me[_e].textContent==="WORLD_WAKE_UP_ACTIVE"&&Me[_e].classList.add("addTipO"),Me[_e].textContent==="WORLD_WAKE_UP_CALM"&&Me[_e].classList.add("addTipL"),Me[_e].textContent==="CAMERA_MOVE_SPIN"&&Me[_e].classList.add("addTipM"),Me[_e].textContent==="CAMERA_STOP_MOVING"&&Me[_e].classList.add("addTipN"),Me[_e].textContent==="CAMERA_MOVE_SPIN_CLOSE"&&Me[_e].classList.add("addTipB"),Me[_e].textContent==="CUBE_ROTATED_STACK_BIG"&&Me[_e].classList.add("addTipG"),Me[_e].textContent==="CUBE_ROTATED_STACK_MEDIUM"&&Me[_e].classList.add("addTipH"),Me[_e].textContent==="CUBE_LITTLE_TOWER"&&Me[_e].classList.add("addTipJ"),Me[_e].addEventListener("click",()=>{document.body.focus()});
//# sourceMappingURL=index-20901c54.js.map
